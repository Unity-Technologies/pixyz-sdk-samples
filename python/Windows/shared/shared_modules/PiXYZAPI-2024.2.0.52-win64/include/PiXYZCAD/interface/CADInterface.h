...
public:
   ...
   */
   virtual Body createBoundedLinearExtrusionBody(const ProfileBase & profileBase, const GeomI::Vector3 & direction, const GeomI::Point3 & planeOrigin, const GeomI::Vector3 & planeNormal, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) final ;
   ...
   */
   virtual Body createCurveExtrusionBody(const ProfileBase & profileBase, const Curve & curve, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) final ;
   ...
   */
   virtual Body createLinearExtrusionBody(const ProfileBase & profileBase, const GeomI::Vector3 & direction, const CoreI::Double & depth, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) final ;
   ...
   /*!
     ...
     \return boundedLinearExtrusion The created body
   */
   virtual Body createMultiExtrusionBody(const ProfileBaseList & profileBaseList, const CurveListList & profileExtrusionList, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full) final ;
   ...
   */
   virtual Body createRevolveExtrusionBody(const ProfileBase & profileBase, const GeomI::Point3 & center, const GeomI::Vector3 & axis, const CoreI::Double & angle, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) final ;
   ...
   */
   virtual CoreI::Double getModelPrecision(const Model & model) final ;
   ...
   */
   virtual MaterialI::Material getEdgeMaterial(const Edge & edge) final ;
   ...
   */
   virtual void setEdgeMaterial(const Edge & edge, const MaterialI::Material & material) final ;
   ...
   */
   virtual CoEdge createCoEdge(const Edge & edge, const GeomI::Orientation & orientation, const Surface & surface = 0, const Curve & curve2D = 0, const CoreI::Boolean & computeGateway = false) final ;
   ...
   */
   ...
   /*!
     ...
     \return edge The created edge
   */
   virtual Edge createEdgeWithBounds(const Curve & curve, const Vertex & startVertex, const Vertex & endVertex, const Bounds1D & bounds) final ;
   ...
   */
   virtual Loop createLoop(const CoEdgeList & coEdges, const CoreI::Boolean & check = true, const CoreI::Boolean & deleteIsolatedVertices = true) final ;
   ...
   /*!
     ...
     \return loop The created loop
   */
   virtual Loop createLoopFromCurve(const Curve & curve) final ;
   ...
   */
   virtual void invertFaces(const FaceList & faces, const CoreI::Boolean & invertLoops = true) final ;
   ...
   */
   virtual Surface createConeSurface(const GeomI::Distance & radius, const CoreI::Double & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) final ;
   ...
   */
   virtual Surface createCurveExtrusionSurface(const Curve & generatrixCurve, const Curve & directrixCurve, const Surface & refSurface = 0) final ;
   ...
   */
   virtual Surface createEllipticConeSurface(const GeomI::Distance & radius1, const GeomI::Distance & radius2, const CoreI::Double & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) final ;
   ...
   */
   virtual Surface createRevolutionSurface(const Curve & generatrixCurve, const GeomI::Point3 & axisOrigin, const GeomI::Vector3 & axisDirection, const CoreI::Double & startParam = 0, const CoreI::Double & endParam = CoreI::TwoPi()) final ;
