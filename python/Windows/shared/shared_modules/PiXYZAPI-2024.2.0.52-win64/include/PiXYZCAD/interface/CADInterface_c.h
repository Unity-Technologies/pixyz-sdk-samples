...
PXZ_EXPORTED CAD_Body CAD_createBoundedLinearExtrusionBody(Session * pxzSession, CAD_ProfileBase profileBase, Geom_Vector3 direction, Geom_Point3 planeOrigin, Geom_Vector3 planeNormal, Geom_Vector3 startTangent, CAD_ExtrusionBoundaryType boundaryType, CAD_ProfileBase profileEnd);
// create a curve extrusion body
PXZ_EXPORTED CAD_Body CAD_createCurveExtrusionBody(Session * pxzSession, CAD_ProfileBase profileBase, CAD_Curve curve, Geom_Vector3 startTangent, CAD_ExtrusionBoundaryType boundaryType, CAD_ProfileBase profileEnd);
// create a linear extrusion body
PXZ_EXPORTED CAD_Body CAD_createLinearExtrusionBody(Session * pxzSession, CAD_ProfileBase profileBase, Geom_Vector3 direction, Core_Double depth, Geom_Vector3 startTangent, CAD_ExtrusionBoundaryType boundaryType, CAD_ProfileBase profileEnd);
// create a linear extrusion body
PXZ_EXPORTED CAD_Body CAD_createMultiExtrusionBody(Session * pxzSession, CAD_ProfileBaseList profileBaseList, CAD_CurveListList profileExtrusionList, CAD_ExtrusionBoundaryType boundaryType);
// create a revolved extrusion body
PXZ_EXPORTED CAD_Body CAD_createRevolveExtrusionBody(Session * pxzSession, CAD_ProfileBase profileBase, Geom_Point3 center, Geom_Vector3 axis, Core_Double angle, Geom_Vector3 startTangent, CAD_ExtrusionBoundaryType boundaryType, CAD_ProfileBase profileEnd);
...
PXZ_EXPORTED Core_Double CAD_getModelPrecision(Session * pxzSession, CAD_Model model);
...
PXZ_EXPORTED Material_Material CAD_getEdgeMaterial(Session * pxzSession, CAD_Edge edge);
...
PXZ_EXPORTED void CAD_setEdgeMaterial(Session * pxzSession, CAD_Edge edge, Material_Material material);
...
PXZ_EXPORTED CAD_CoEdge CAD_createCoEdge(Session * pxzSession, CAD_Edge edge, Geom_Orientation orientation, CAD_Surface surface, CAD_Curve curve2D, Core_Boolean computeGateway);
...
PXZ_EXPORTED CAD_Edge CAD_createEdgeWithBounds(Session * pxzSession, CAD_Curve curve, CAD_Vertex startVertex, CAD_Vertex endVertex, CAD_Bounds1D bounds);
...
PXZ_EXPORTED CAD_Loop CAD_createLoop(Session * pxzSession, CAD_CoEdgeList coEdges, Core_Boolean check, Core_Boolean deleteIsolatedVertices);
// Create a loop from a finite curve
PXZ_EXPORTED CAD_Loop CAD_createLoopFromCurve(Session * pxzSession, CAD_Curve curve);
...
// Invert faces
PXZ_EXPORTED void CAD_invertFaces(Session * pxzSession, CAD_FaceList faces, Core_Boolean invertLoops);
// Invert a loop
...
PXZ_EXPORTED CAD_Surface CAD_createConeSurface(Session * pxzSession, Geom_Distance radius, Core_Double semiAngle, Geom_Matrix4 matrix);
...
PXZ_EXPORTED CAD_Surface CAD_createEllipticConeSurface(Session * pxzSession, Geom_Distance radius1, Geom_Distance radius2, Core_Double semiAngle, Geom_Matrix4 matrix);
...
PXZ_EXPORTED CAD_Surface CAD_createRevolutionSurface(Session * pxzSession, CAD_Curve generatrixCurve, Geom_Point3 axisOrigin, Geom_Vector3 axisDirection, Core_Double startParam, Core_Double endParam);
