...
namespace UnityEngine.Pixyz.Material {
	...
	[Serializable]
	[StructLayout(LayoutKind.Sequential)]
	public struct MaterialFromMapsReturn
	{
		public MaterialFromMapsReturn(MaterialFromMapsReturn o) {
			this.importedTextureCount = o.importedTextureCount;
			this.createdMaterialCount = o.createdMaterialCount;
			this.updatedMaterialCount = o.updatedMaterialCount;
		}
		public System.Int32 importedTextureCount;
		public System.Int32 createdMaterialCount;
		public System.Int32 updatedMaterialCount;
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct MaterialFromMapsReturn_c
	{
		public Int32 importedTextureCount;
		public Int32 createdMaterialCount;
		public Int32 updatedMaterialCount;
	}
	...
	public enum ResizeFilterMethod
	{
		DEFAULT = 0,
		BOX = 1,
		TRIANGLE = 2,
	...
	[Serializable]
	[StructLayout(LayoutKind.Sequential)]
	public class GetImagesSizesReturn
	{
		public GetImagesSizesReturn() {}
		public GetImagesSizesReturn(GetImagesSizesReturn o) {
			this.widths = o.widths;
			this.heights = o.heights;
		}
		public Core.IntList widths;
		public Core.IntList heights;
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct GetImagesSizesReturn_c
	{
		public Core.IntList_c widths;
		public Core.IntList_c heights;
	}
