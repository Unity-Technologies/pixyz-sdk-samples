...
PXZ_EXPORTED Scene_Occurrence Scene_createHierarchicalClusters(Session * pxzSession, Scene_Occurrence root, Core_Int childrenCountByNode, Core_Coeff minFitting);
...
PXZ_EXPORTED Geom_AABB Scene_getAABB(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Boolean precise);
...
PXZ_EXPORTED Material_MaterialList Scene_getActiveMaterials(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED Scene_BRepShape Scene_getBrepShape(Session * pxzSession, Scene_Part part);
...
PXZ_EXPORTED Geom_Matrix4List Scene_getGlobalMatrices(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED Geom_Matrix4List Scene_getLocalMatrices(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED Geom_MBB Scene_getMBB(Session * pxzSession, Scene_OccurrenceList occurrences, Geom_Vector3 forcedAxis);
...
PXZ_EXPORTED Core_Double Scene_getVolume(Session * pxzSession, Scene_Occurrence occurrence);
// Return the volume of a set of root occurrences
PXZ_EXPORTED Core_DoubleList Scene_getVolumes(Session * pxzSession, Scene_OccurrenceList iRoots);
...
PXZ_EXPORTED Core_Bool Scene_isAncestorOf(Session * pxzSession, Scene_Occurrence maybeAncestor, Scene_Occurrence occurrence);
// Filter a list of occurrences by removing all occurrences which have an ancestor inside the list.
PXZ_EXPORTED Scene_OccurrenceList Scene_keepAncestors(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED void Scene_transferMaterialsOnPatches(Session * pxzSession, Scene_Occurrence rootOccurrence);
   ...
   */
PXZ_EXPORTED Core_Ident Scene_addComponentChangedCallback(Session * pxzSession, void(*fp)(void *, Scene_ComponentChangeType, Scene_Occurrence, Scene_Component), void * userdata = nullptr);
PXZ_EXPORTED void Scene_removeComponentChangedCallback(Session * pxzSession, Core_Ident id);
...
// Create a new torus
PXZ_EXPORTED Scene_Occurrence Scene_createTorus(Session * pxzSession, Core_Double majorRadius, Core_Double minorRadius, Core_Int subdivisionLatitude, Core_Int subdivisionLongitude, Core_Boolean generateUV);
...
PXZ_EXPORTED void Scene_setSubpartMaterials(Session * pxzSession, Scene_Occurrence occurrence, Material_MaterialList materials, Core_UInt startIndex);
...
typedef struct {
   Core_Double maxSag;
   Core_Double maxLength;
   Core_Double maxAngle;
   Core_Bool createNormals;
   Scene_UVGenerationMode uvGenerationMode;
   Core_Int uvChannel;
   Core_Double uvPadding;
   Core_Bool createTangents;
   Core_Bool createFreeEdges;
} Scene_getTessellationParametersReturn;
PXZ_EXPORTED Scene_getTessellationParametersReturn Scene_getTessellationParameters(Session * pxzSession, Scene_Part part);
...
PXZ_EXPORTED Scene_OccurrenceList Scene_findPartOccurrencesWithUnstitchedOpenShells(Session * pxzSession, Scene_Occurrence root);
...
PXZ_EXPORTED Scene_OccurrenceList Scene_mergePartOccurrencesWithSingleOpenShellByAssemblies(Session * pxzSession, Scene_Occurrence root);
...
PXZ_EXPORTED void Scene_setLocalMatrices(Session * pxzSession, Scene_OccurrenceList occurrencesIds, Geom_Matrix4List matrices, Core_UInt batchSize);
...
PXZ_EXPORTED Scene_Occurrence Scene_createOccurrenceFromAnnotation(Session * pxzSession, Scene_Annotation annotation, Core_Boolean convertVisibility);
// Create a productview from definition
PXZ_EXPORTED Scene_ProductView Scene_createProductView(Session * pxzSession, Scene_ProductViewDefinition definition);
...
PXZ_EXPORTED Geom_AABB Scene_getAnnotationListAABB(Session * pxzSession, Scene_AnnotationList annotationList);
...
PXZ_EXPORTED Scene_OccurrenceList Scene_getPrototypes(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED void Scene_setPrototypes(Session * pxzSession, Scene_OccurrenceList occurrences, Scene_OccurrenceList prototypes);
// Update children prototypes of the given occurrence
PXZ_EXPORTED void Scene_updateChildrenPrototypes(Session * pxzSession, Scene_Occurrence occurrence);
...
PXZ_EXPORTED Core_ULong Scene_getSelectedPolygonCount(Session * pxzSession);
...
PXZ_EXPORTED void Scene_invertSelect(Session * pxzSession, Scene_OccurrenceList occurrence);
...
PXZ_EXPORTED void Scene_endModifyAllVariants(Session * pxzSession);
...
PXZ_EXPORTED void Scene_startModifyAllVariants(Session * pxzSession);
