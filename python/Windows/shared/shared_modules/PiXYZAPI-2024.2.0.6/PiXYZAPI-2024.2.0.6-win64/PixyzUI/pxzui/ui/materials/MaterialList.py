...
def onMaterialChanged(materialChangeType, id, materialList):
    materialList.onMaterialChanged(materialChangeType, id)

def onResetSession(materialList):
    materialList.onResetSession()
