...
def onImageChanged(imageChangeType, id, textureLibrary):
    textureLibrary.onImageChanged(imageChangeType, id)
...
class TextureLibrary:
    def __init__(self):
        ...
        pxz.material.addImageChangedCallback(onImageChanged, self)
            ...
            match imageChangeType:
                case pxz.material.ImageChangeType.ADDED:
                    ...
                    self._allImageDefinitions[imageId] = {"definition": imgDef,
                                                          "glTextureId": self.generateGlTextureId(imgDef)}
