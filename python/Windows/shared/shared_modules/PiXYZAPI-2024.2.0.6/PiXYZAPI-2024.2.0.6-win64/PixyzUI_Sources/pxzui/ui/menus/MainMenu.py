...
from pxzui.ui.menus.Materials import Materials
from pxzui.ui.menus.Session import *
from pxzui.ui.menus.Functions import *
from pxzui.ui.menus.Selection import *
...
class MainMenu:
    def __init__(self, ui):
        ...
        self.IO = IO(ui)
        self.selection = Selection(ui)
        self.functions = Functions(ui)
