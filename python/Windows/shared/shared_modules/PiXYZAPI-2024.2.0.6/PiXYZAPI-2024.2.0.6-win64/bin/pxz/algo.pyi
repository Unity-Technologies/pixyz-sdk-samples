...
class BakeMap:
	...
	def __init__(self, type: MapType, properties: list[scene.PropertyValue]) -> BakeMap: ...
	...
...
class BakeMaps:
	...
	emissive: bool
	def __init__(self, diffuse: bool, normal: bool, roughness: bool, metallic: bool, opacity: bool, ambientOcclusion: bool, emissive: bool) -> BakeMaps: ...
	...
...
class BakeOption:
	...
	padding: int
	textures: BakeMaps
	def __init__(self, bakingMethod: BakingMethod, resolution: int, padding: int, textures: BakeMaps) -> BakeOption: ...
	...
...
class Box:
	...
	height: float
	depth: float
	def __init__(self, position: geom.Affine, length: float, height: float, depth: float) -> Box: ...
	...
...
class BoxParameters:
	...
	SizeZ: float
	Subdivision: int
	def __init__(self, SizeX: float, SizeY: float, SizeZ: float, Subdivision: int) -> BoxParameters: ...
	...
...
class CapsuleParameters:
	...
	Latitude: int
	Longitude: int
	def __init__(self, Radius: float, Height: float, Latitude: int, Longitude: int) -> CapsuleParameters: ...
	...
...
class ConeParameters:
	...
	Height: float
	Sides: int
	def __init__(self, BottomRadius: float, Height: float, Sides: int) -> ConeParameters: ...
	...
...
class CustomBakeMap:
	...
	name: str
	component: int
	def __init__(self, name: str, component: int) -> CustomBakeMap: ...
	...
...
class Cylinder:
	...
	radius: float
	length: float
	def __init__(self, position: geom.Affine, radius: float, length: float) -> Cylinder: ...
	...
...
class CylinderParameters:
	...
	Height: float
	Sides: int
	def __init__(self, Radius: float, Height: float, Sides: int) -> CylinderParameters: ...
	...
...
class Feature:
	...
	def __init__(self, type: FeatureType, inputs: list[FeatureInput]) -> Feature: ...
	...
...
class FeatureInput:
	...
	diameter: float
	def __init__(self, position: geom.Point3, direction: geom.Point3, diameter: float) -> FeatureInput: ...
	...
...
class HexahedronParameters:
	...
	YLength: float
	ZLength: float
	def __init__(self, XLength: float, YLength: float, ZLength: float) -> HexahedronParameters: ...
	...
...
class LegoReturn:
	...
	"""
	Root: int
	Bricks: list[cad.LegoBrickDefinition]
	def __init__(self, Root: int, Bricks: list[cad.LegoBrickDefinition]) -> LegoReturn: ...
	...
...
class MaxTransformationType(Enum):
	"""
	"""
	Similarity: int
	Affine: int
...
class OccurrenceFeatures:
	...
	def __init__(self, occurrence: int, features: list[Feature]) -> OccurrenceFeatures: ...
	...
...
class OctahedralImpostor:
	...
	AOMap: int
	RoughnessMap: int
	def __init__(self, OctaTransform: list[list[float]], Radius: float, NormalMap: int, DepthMap: int, DiffuseMap: int, MetallicMap: int, AOMap: int, RoughnessMap: int) -> OctahedralImpostor: ...
	...
...
class Plane:
	...
	length: float
	height: float
	def __init__(self, position: geom.Affine, length: float, height: float) -> Plane: ...
	...
...
class PlaneParameters:
	...
	SubdivisionX: int
	SubdivisionY: int
	def __init__(self, SizeX: float, SizeY: float, SubdivisionX: int, SubdivisionY: int) -> PlaneParameters: ...
	...
...
class ReplaceByOccurrenceOptions:
	...
	Occurrence: int
	Aligned: bool
	def __init__(self, Occurrence: int, Aligned: bool) -> ReplaceByOccurrenceOptions: ...
	...
...
class ReplaceByPrimitiveOptions:
	...
	Aligned: bool
	GenerateUV: bool
	def __init__(self, Type: list, Aligned: bool, GenerateUV: bool) -> ReplaceByPrimitiveOptions: ...
	...
...
class Sphere:
	...
	position: geom.Affine
	radius: float
	def __init__(self, position: geom.Affine, radius: float) -> Sphere: ...
	...
...
class SphereParameters:
	...
	Latitude: int
	Longitude: int
	def __init__(self, Radius: float, Latitude: int, Longitude: int) -> SphereParameters: ...
	...
...
def decimateTarget(occurrences: list[int], targetStrategy: list, UVImportance: UVImportanceEnum = 0, protectTopology: bool = False, iterativeThreshold: int = 5000000, processMeshIndependently: bool = False) -> None:
...
def filletMesh(occurrences: list[int], value: float, filletingMode: FilletingMode = 0, subdivisionNb: int = 0, createFlatChamfer: bool = False, material: int = int()) -> None:
...
def meshIntersections(occurrence1: int, occurrence2: int) -> list[list[geom.Point3]]:
	"""Computes the intersections between the meshes of two occurrences

	Args:
		occurrence1 (int): First Occurrence
		occurrence2 (int): Second Occurrence
...
def bakeUV(source: int, destination: int, sourceChannel: int = 0, destinationChannel: int = 0, tolerance: float = 0.001) -> None:
	...
	Args:
		...
		tolerance (float): Tolerance when point is projected on seam (if the model come from a decimation it is recommended to use the lineic tolerance here)
	"""
	...
...
def combineMeshes(occurrences: list[int], bakingOptions: BakeOption, overrideExistingUVs: bool = False) -> int:
	"""Combine all given meshes to one mesh with one material (baked)
...
def explodeConnectedMeshes(occurrences: list[int]) -> None:
...
def legoDecomposition(root: int, bricks: list[cad.LegoBrickDefinition], colors: list[core.Color], density: int = 100, forceFillingWithSmallBricks: bool = True) -> LegoReturn:
	"""Decompose a model in a set of lego bricks

	Args:
		root (int): The model root occurrence
		bricks (list[cad.LegoBrickDefinition]): 
		colors (list[core.Color]): 
		density (int): 
		forceFillingWithSmallBricks (bool): 

	Returns:
		decomposition (LegoReturn): The root occurrence of the decomposition and the list of bricks used
	"""
	...

def createVisibilityInformation(occurrences: list[int], level: SelectionLevel, resolution: int, sphereCount: int, fovX: float = 90, considerTransparentOpaque: bool = False, root: int = 0) -> None:
...
def createVisibilityInformationAdvanced(occurrences: list[int], voxelSize: float, minimumCavityVolume: float, resolution: int, mode: InnerOuterOption = 0, considerTransparentOpaque: bool = False, root: int = 0) -> None:
...
def findOccludedPartOccurrences(occurrences: list[int], resolution: int, sphereCount: int, fovX: float = 90, considerTransparentOpaque: bool = False, root: int = 0) -> list[int]:
...
def removeOccludedGeometries(occurrences: list[int], level: SelectionLevel, resolution: int, sphereCount: int, fovX: float = 90, considerTransparentOpaque: bool = False, adjacencyDepth: int = 1, root: int = 0) -> list[bool]:
...
def removeOccludedGeometriesAdvanced(occurrences: list[int], level: SelectionLevel, voxelSize: float, minimumCavityVolume: float, resolution: int, mode: InnerOuterOption = 0, considerTransparentOpaque: bool = False, adjacencyDepth: int = 1, root: int = 0) -> list[bool]:
...
def removeOccludedGeometriesFromPoints(occurrences: list[int], level: SelectionLevel, positions: list[geom.Point3], resolution: int, sphereCount: int, fovX: float = 90, considerTransparentOpaque: bool = False, adjacencyDepth: int = 1, root: int = 0) -> list[bool]:
...
def removeOccludedGeometriesFromViewPoints(occurrences: list[int], level: SelectionLevel, positions: list[geom.Point3], directions: list[geom.Point3], ups: list[geom.Point3], resolution: int, fovX: float = 90, considerTransparentOpaque: bool = False, adjacencyDepth: int = 1, root: int = 0) -> list[bool]:
...
def dualContouring(occurrences: list[int], minFixedDepth: int, maxDepth: int, tolerance: float, sameSizeOnAllAxis: bool, aabb: geom.AABB) -> int:
	...
	Args:
		...
		aabb (geom.AABB): AABB to use for the root of the octree
...
def dualContouringTarget(occurrences: list[int], filteringSize: float, voxelSize: float, tolerance: float, sameSizeOnAllAxis: bool) -> int:
...
def automaticUVMapping(occurrences: list[int], channel: int = 0, maxAngleDistorsion: float = 0.5, maxAreaDistorsion: float = -1, sharpToSeam: bool = True, forbidOverlapping: bool = True) -> None:
...
def defragmentUVIslands(occurrences: list[int], channel: int, targetIslandCount: int = 0, energyThreshold: float = 0.01, forceIsolatedFaces: bool = True) -> None:
...
def flattenUV(occurrences: list[int], channel: int = 0, iterations: int = 1, newtonTolf: float = 1.0, newtonTolx: float = 1.0) -> None:
	...
	Args:
		...
		newtonTolf (float): Threshold for gradient normals
		newtonTolx (float): Threshold for gradient normals
	"""
	...
...
def mapUvOnFittingCylinder(occurrences: list[int], channel: int = 0, overrideExistingUVs: bool = True, useAABB: bool = True) -> None:
	...
	Args:
		...
		channel (int): The UV channel which will contains the texture coordinates
		overrideExistingUVs (bool): If True, override existing UVs on channel
		useAABB (bool): If true use for the fitting the global Axis Aligned Bounding Box (AABB), else use a Minimum Bounding Box (MBB only based on transformed AABB of occurrences)
	"""
	...
...
def mergeUVIslands(occurrences: list[int], channel: int = 0, scaleWeights: float = 0, maxScaleVariationFactor: float = 1.2, curvatureWeights: float = -1, usePolygonsWeights: float = 1, useVerticesWeights: float = -1, maxTransformationType: MaxTransformationType = 0, allowUVInversion: bool = False) -> None:
...
def relaxUV(occurrences: list[int], method: RelaxUVMethod, iterations: int = 100, channel: int = 0) -> None:
	"""Relax UVs
...
def smoothUV(occurrences: list[int], iterations: int = 1, channel: int = 0) -> None:
...
def getFittingCylinder(occurrences: list[int], useAABB: bool = True) -> geom.Affine:
	"""Returns the fitting cylinder of a set of occurrences (based on MBB)

	Args:
		occurrences (list[int]): Occurrences to fit
		useAABB (bool): If true use the global Axis Aligned Bounding Box (AABB), else use a Minimum Bounding Box MBB only based on transformed AABB of occurrences)
...
def barySmooth(occurrences: list[int], iteration: int) -> None:
...
def remeshSurfacicHoles(occurrences: list[int], maxDiameter: float) -> None:
...
def vertexOffset(occurrences: list[int], offset: float) -> None:
...
def toEditableMesh(occurrences: list[int]) -> None:
	"""Convert all static mesh to editable mesh

	Args:
		occurrences (list[int]): Occurrences to convert to editable mesh
	"""
	...

def toStaticMesh(occurrences: list[int]) -> None:
	"""Convert all editable mesh to static mesh

	Args:
		occurrences (list[int]): Occurrences to convert to static mesh
	"""
	...
