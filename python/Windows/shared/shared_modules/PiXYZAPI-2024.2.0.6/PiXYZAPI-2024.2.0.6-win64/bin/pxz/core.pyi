...
class AliasTypeDesc:
	...
	"""
	alias: str
	def __init__(self, alias: str) -> AliasTypeDesc: ...
	...
...
class ArrayTypeDesc:
	...
	arrayType: str
	size: int
	def __init__(self, arrayType: str, size: int) -> ArrayTypeDesc: ...
	...
...
class AutoValueReturn:
	...
	message: str
	def __init__(self, values: list[StringPair], message: str) -> AutoValueReturn: ...
	...
...
class BoundedInteger:
	...
	min: int
	max: int
	def __init__(self, value: int, min: int, max: int) -> BoundedInteger: ...
	...
...
class ColorAlpha:
	...
	b: float
	a: float
	def __init__(self, r: float, g: float, b: float, a: float) -> ColorAlpha: ...
	...
...
class ConstantDesc:
	...
	type: TypeDesc
	description: str
	def __init__(self, name: str, value: str, type: TypeDesc, description: str) -> ConstantDesc: ...
	...
...
class Date:
	...
	month: int
	day: int
	def __init__(self, year: int, month: int, day: int) -> Date: ...
	...
...
class EnumPropertyInfo:
	...
	values: list[int]
	labels: list[str]
	def __init__(self, name: str, values: list[int], labels: list[str]) -> EnumPropertyInfo: ...
	...
...
class EnumTypeDesc:
	...
	labels: list[str]
	valueType: str
	def __init__(self, values: list[int], labels: list[str], valueType: str) -> EnumTypeDesc: ...
	...
...
class EventDesc:
	...
	def __init__(self, module: str, name: str, description: str, parameters: list[ParameterDesc]) -> EventDesc: ...
	...
...
class Field:
	...
	def __init__(self, name: str, type: str, module: str, defaultValue: str, description: str, disableValue: str, predefinedValues: list[StringPair]) -> Field: ...
	...
...
class Format:
	...
	name: str
	extensions: list[str]
	def __init__(self, name: str, extensions: list[str]) -> Format: ...
	...
...
class FunctionDesc:
	...
	description: str
	stability: Stability
	def __init__(self, name: str, module: str, parameters: list[ParameterDesc], returns: list[ParameterDesc], description: str, stability: Stability) -> FunctionDesc: ...
	...
...
class GroupDesc:
	...
	def __init__(self, name: str, description: str, functions: list[FunctionDesc]) -> GroupDesc: ...
	...
...
class IdentPair:
	...
	key: int
	value: int
	def __init__(self, key: int, value: int) -> IdentPair: ...
	...
...
class LicenseInfos:
	...
	def __init__(self, version: str, customerName: str, customerCompany: str, customerEmail: str, isFloating: bool, isRevocable: bool, startDate: Date, endDate: Date, invalidReasons: list[str]) -> LicenseInfos: ...
	...
...
class ListTypeDesc:
	...
	"""
	listType: str
	def __init__(self, listType: str) -> ListTypeDesc: ...
	...
...
class ModuleDesc:
	...
	stability: Stability
	def __init__(self, name: str, description: str, author: str, groups: list[GroupDesc], types: list[TypeDesc], constants: list[ConstantDesc], dependencies: list[str], stability: Stability) -> ModuleDesc: ...
	...
...
class ParameterDesc:
	...
	def __init__(self, name: str, type: TypeDesc, description: str, optional: bool, defaultValue: str, disableValue: str, attributes: list[StringPair]) -> ParameterDesc: ...
	...
...
class PropertyInfo:
	...
	group: str
	description: str
	def __init__(self, name: str, type: PropertyType, subType: int, value: str, user: bool, defaultValue: str, editable: bool, isSet: bool, delegated: bool, delegatedOwnerEntity: int, group: str, description: str) -> PropertyInfo: ...
	...
...
class SelType:
	...
	defaultValue: str
	description: str
	def __init__(self, name: str, type: str, defaultValue: str, description: str) -> SelType: ...
	...
...
class SelectTypeDesc:
	...
	"""
	types: list[SelType]
	def __init__(self, types: list[SelType]) -> SelectTypeDesc: ...
	...
...
class StringPair:
	...
	key: str
	value: str
	def __init__(self, key: str, value: str) -> StringPair: ...
	...
...
class StructTypeDesc:
	...
	"""
	fields: list[Field]
	def __init__(self, fields: list[Field]) -> StructTypeDesc: ...
	...
...
class TypeDesc:
	...
	description: str
	definition: list
	def __init__(self, name: str, module: str, type: TypeDescType, description: str, definition: list) -> TypeDesc: ...
	...
...
class WebLicenseInfo:
	...
	onMachine: bool
	current: bool
	def __init__(self, id: int, product: str, validity: Date, count: int, inUse: int, revoke: int, description: str, onMachine: bool, current: bool) -> WebLicenseInfo: ...
	...
...
def unlockProcessing() -> None:
	"""Unlock the mutex that ensure no processing is done between lock/unlock
	"""
	...

def askString(msg: str, defaultValue: str = "") -> str:
	"""Invite the user to enter a string

	Args:
		msg (str): Message to display
		defaultValue (str): Message to display

	Returns:
		text (str): The string entered by the user
	"""
	...

def askYesNo(question: str, defaultValue: bool = False) -> bool:
	"""Ask a question which need a Yes/No answer

	Args:
		question (str): Question to display
		defaultValue (bool): Default value (if interfactive mode is disabled)

	Returns:
		answer (bool): True if the user say Yes, else False
	"""
	...

def choose(message: str, values: list[str], defaultValue: int = 0) -> int:
	"""Invite the user to choose one value between multiple choice

	Args:
		message (str): Message to display
		values (list[str]): Possible values to choose
		defaultValue (int): Default value index

	Returns:
		choice (int): Index of the chosen value in the values list
	"""
	...
...
def isInteractiveMode() -> bool:
	"""Returns True if the script is in interactive mode, else returns false

	Returns:
		interactive (bool): True if interactive, else false
	"""
	...
...
def setInteractiveMode(interactive: bool = True) -> None:
	...
	Args:
		interactive (bool): True if you want to enter interactive mode, else False
	"""
	...
...
def parallelAddJob(session: Ptr, jobCallback: Callable[[Ptr], None], data: Ptr) -> None:
...
def getOutputFilePath(fileName: str, data: str = "none") -> str:
	...
	Args:
		fileName (str): The desired file name (suffix of the path)
		data (str): Optional data associated with file

	Returns:
		filePath (str): The complete generated file path
	"""
	...
...
def pushAnalytic(name: str, data: str = "") -> None:
	"""push custom analytic event (Only for authorized products)

	Args:
		name (str): Analytic event name
		data (str): Analytic event data
	"""
	...
...
def startUndoRedoStep(stepName: str) -> None:
