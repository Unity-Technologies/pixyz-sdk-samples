...
class ColorMaterialInfos:
	...
	def __init__(self, name: str, color: core.ColorAlpha) -> ColorMaterialInfos: ...
	...
...
class ImageDefinition:
	...
	componentsCount: int
	data: list[core.Byte]
	def __init__(self, id: int, name: str, width: int, height: int, bitsPerComponent: int, componentsCount: int, data: list[core.Byte]) -> ImageDefinition: ...
	...
...
class ImpostorMaterialInfos:
	...
	linearSteps: int
	binarySteps: int
	def __init__(self, name: str, albedo: list, normal: list, roughness: list, ao: list, depth: list, nbFrames: int, fullOcta: bool, octaDiameter: float, linearSteps: int, binarySteps: int) -> ImpostorMaterialInfos: ...
	...
...
class MaterialDefinition:
	...
	opacity: list
	emissive: list
	def __init__(self, name: str, id: int, albedo: list, normal: list, metallic: list, roughness: list, ao: list, opacity: list, emissive: list) -> MaterialDefinition: ...
	...
...
class PBRMaterialInfos:
	...
	ao: list
	opacity: list
	def __init__(self, name: str, albedo: list, normal: list, metallic: list, roughness: list, ao: list, opacity: list) -> PBRMaterialInfos: ...
	...
...
class StandardMaterialInfos:
	...
	shininess: float
	transparency: float
	def __init__(self, name: str, diffuse: list, specular: list, ambient: list, emissive: list, shininess: float, transparency: float) -> StandardMaterialInfos: ...
	...
...
class Texture:
	...
	offset: geom.Point2
	tilling: geom.Point2
	def __init__(self, image: int, channel: int, offset: geom.Point2, tilling: geom.Point2) -> Texture: ...
	...
...
class UnlitTextureMaterialInfos:
	...
	name: str
	texture: Texture
	def __init__(self, name: str, texture: Texture) -> UnlitTextureMaterialInfos: ...
	...
...
def createMaterialsFromMaps(directory: str) -> None:
...
def getImportImageFormats() -> list[core.Format]:
	...
	Returns:
		formats (list[core.Format]): Image formats that can be imported in Pixyz
	"""
	...
...
def resizeImage(image: int, width: int, height: int) -> None:
	"""Resize an image
