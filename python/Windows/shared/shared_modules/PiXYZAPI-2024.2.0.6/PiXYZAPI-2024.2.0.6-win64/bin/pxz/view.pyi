...
class AnimationPlayerInfo:
	...
	currentFrame: int
	speed: float
	def __init__(self, isPlaying: bool, isLooping: bool, currentFrame: int, speed: float) -> AnimationPlayerInfo: ...
	...
...
class EncoderSettings:
	...
	qp: QP
	targetQuality: int
	def __init__(self, frameRate: int, averageBitRate: int, maxBitRate: int, rateControl: RateControl, qp: QP, targetQuality: int) -> EncoderSettings: ...
	...
...
class GraphicsContext:
	...
	api: GraphicAPI
	context: core.Ptr
	def __init__(self, api: GraphicAPI, context: core.Ptr) -> GraphicsContext: ...
	...
...
class QP:
	...
	qpInterB: int
	qpIntra: int
	def __init__(self, qpInterP: int, qpInterB: int, qpIntra: int) -> QP: ...
	...
...
class StreamedViewerInfo:
	...
	port: int
	viewer: int
	def __init__(self, host: str, port: int, viewer: int) -> StreamedViewerInfo: ...
	...
...
class WebRTCInfo:
	...
	udpPortRangeEnd: int
	def __init__(self, signalingUrl: str, stunServer: str, udpPortRangeBegin: int, udpPortRangeEnd: int) -> WebRTCInfo: ...
	...
...
def refreshViewer(viewer: int = -1, frameCount: int = 1, forceUpdate: bool = False) -> None:
	"""Refresh the viewer

	Args:
		viewer (int): Viewer to refresh
		frameCount (int): Number of frames to render
		forceUpdate (bool): Force the viewer to update pending modification on the geometry. By default this is disabled while running process
	"""
	...
...
def fitCamera(direction: geom.Point3, cameraType: CameraType, fov: float, viewer: int = -1, fitToOccurrence: int = 0) -> None:
