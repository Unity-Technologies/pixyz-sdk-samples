...
class PXZ_EXPORTED AlgoInterface : public IAlgoInterface
{
public:
   ...
   */
   virtual void assembleCAD(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & tolerance, const CoreI::Boolean & removeDuplicatedFaces = true) final ;
   ...
   */
   virtual void backToInitialBRep(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void bakeVertexAttributes(const SceneI::OccurrenceList & destinationOccurrences, const SceneI::OccurrenceList & sourceOccurrences, const CoreI::Boolean & skinnedMesh, const CoreI::Boolean & positions, const CoreI::Boolean & useCurrentPositionAsTPose = false) final ;

   //! calculate the normal of each point of a Point Cloud
   /*!
     \param occurrences Part occurrences to process
   */
   virtual void calculateNormalsInPointClouds(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual SceneI::OccurrenceList combineMeshesByMaterials(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & mergeNoMaterials = true, const SceneI::MergeHiddenPartsMode & mergeHiddenPartsMode = SceneI::MergeHiddenPartsMode::Destroy) final ;
   ...
   */
   virtual void crackCADMoebiusStrip(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void crackEdges(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & useAttributesFilter = true, const GeomI::Angle & sharpAngleFilter = 45, const CoreI::Boolean & useNonManifoldFilter = false) final ;
   ...
   */
   virtual void crackMeshEdges(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & normal = false, const CoreI::Boolean & uvs = false, const CoreI::IntList & uvChannels = CoreI::IntList(0), const CoreI::Boolean & loi = false, const CoreI::Boolean & patches = false, const CoreI::Boolean & nman = false) final ;

   //! Create free edges from patch borders
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void createFreeEdgesFromPatches(const SceneI::OccurrenceList & occurrences) final ;

   //! Create identified patch from existing patch (this is useful before cloning for baking)
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void createIdentifiedPatchesFromPatches(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     ...
     \return indexMap 
   */
   virtual MaterialI::Image createIndexMapFromOccurrences(const SceneI::OccurrenceList & occurrences, const CoreI::Int & uvChannel, const CoreI::Bool & createTexture1D) final ;
   ...
   */
   virtual void createNormals(const SceneI::OccurrenceList & occurrences, const GeomI::Angle & sharpEdge = 45, const CoreI::Boolean & override = true, const CoreI::Boolean & useAreaWeighting = false) final ;
   ...
   */
   virtual SceneI::Occurrence createPointCloudKDTree(const SceneI::OccurrenceList & occurrences, const CoreI::Int & depth, const CoreI::Bool & addToScene = true) final ;
   ...
   */
   virtual void createTangents(const SceneI::OccurrenceList & occurrences, const CoreI::Int & uvChannel = 0, const CoreI::Boolean & override = true) final ;

   //! Bake vertex colors using main material color. May duplicate some vertices
   /*!
     \param occurrenceList 
   */
   virtual void createVertexColorFromMaterials(const SceneI::OccurrenceList & occurrenceList) final ;

   //! Create visibility patches from existing patches
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void createVisibilityPatchesFromPatch(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void decimate(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & surfacicTolerance, const GeomI::Distance & lineicTolerance = 0.1, const GeomI::Angle & normalTolerance = 5, const GeomI::Distance & texCoordTolerance = -1, const CoreI::Boolean & releaseConstraintOnSmallArea = false) final ;
   ...
   */
   virtual void decimatePointClouds(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & tolerance = 500) final ;
   ...
   */
   virtual void deleteAttibute(const SceneI::Occurrence & occurrence, const AttributType & type) final ;
   ...
   */
   virtual void deleteBRepShapes(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & onlyTessellated = true) final ;

   //! Delete all free vertices of the mesh of given parts
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void deleteFreeVertices(const SceneI::OccurrenceList & occurrences) final ;

   //! Delete all free line of the mesh of given parts
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void deleteLines(const SceneI::OccurrenceList & occurrences) final ;

   //! Remove normal attributes on tessellations
   /*!
     \param occurrences Occurrences of components to delete
   */
   virtual void deleteNormals(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void deletePatches(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & keepOnePatchByMaterial = true) final ;

   //! Delete all polygons of the mesh of given parts
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void deletePolygons(const SceneI::OccurrenceList & occurrences) final ;

   //! Remove tangent attributes on tessellations
   /*!
     \param occurrences Occurrences of components to delete
   */
   virtual void deleteTangents(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void deleteTextureCoordinates(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = -1) final ;

   //! delete the visibility patches of given occurrences
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void deleteVisibilityPatches(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void extractNeutralAxis(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDiameter, const CoreI::Boolean & removeOriginalMesh) final ;
   ...
   */
   virtual void filletMesh(const SceneI::OccurrenceList & occurrences, const CoreI::Double & value, const FilletingMode & filletingMode = FilletingMode::Width, const CoreI::Int & subdivisionNb = 0, const CoreI::Boolean & createFlatChamfer = false, const MaterialI::Material & material = MaterialI::Material()) final ;
   ...
   */
   virtual void filterHiddenPolygons(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize) final ;
   ...
   */
   virtual GeomI::Matrix4 findBestPivotBetweenOccurrences(const SceneI::OccurrenceList & assembly1, const SceneI::OccurrenceList & assembly2, const CoreI::Double & precision = -1) final ;
   ...
   */
   virtual getAllAxisFromCADModelReturn getAllAxisFromCADModel(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual CoreI::Int getOptimalTextureResolution(const SceneI::OccurrenceList & occurrences, const CoreI::Double & texelPerMm) final ;
   ...
   */
   virtual PolygonalI::TessellationList getTessellations(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual CoreI::Double getUV3dRatio(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual getVisibilityStatsReturn getVisibilityStats(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void identifySharpEdges(const SceneI::OccurrenceList & occurrences, const GeomI::Angle & minSharpAngle, const GeomI::Angle & maxSharpAngle = 180, const ConvexityFilter & convexity = ConvexityFilter::OnConvexAndConcave, const CoreI::Boolean & onlyExplicitSharp = false) final ;
   ...
   */
   virtual void lineToTexture(const SceneI::OccurrenceList & lines, const UseColorOption & useColor, const CoreI::Int & resolution = 512, const CoreI::Int & thickness = 5) final ;
   ...
   */
   virtual OccurrenceFeaturesList listFeatures(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & throughHoles = true, const CoreI::Boolean & blindHoles = false, const GeomI::Distance & maxDiameter = -1) final ;
   ...
   */
   virtual void loopSubdivMesh(const SceneI::OccurrenceList & occurrences, const CoreI::Int & depth) final ;
   ...
   */
   virtual void mergeVertices(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDistance, const PolygonalI::TopologyCategoryMask & mask) final ;
   ...
   */
   virtual GeomI::Distance meshComparison(const SceneI::Occurrence & mesh_1, const SceneI::Occurrence & mesh_2) final ;
   ...
   */
   virtual GeomI::DistanceList meshComparisonBatch(const SceneI::OccurrenceList & meshes1, const SceneI::OccurrenceList & meshes2) final ;

   //! Computes the intersections between the meshes of two occurrences
   /*!
     \param occurrence1 First Occurrence
     \param occurrence2 Second Occurrence
     \return intersections The intersections
   */
   virtual GeomI::Point3ListList meshIntersections(const SceneI::Occurrence & occurrence1, const SceneI::Occurrence & occurrence2) final ;
   ...
   */
   virtual void noiseMesh(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxAmplitude) final ;

   //! Optimize CAD Face loops by merging useless loop edges
   /*!
     \param occurrences Occurrences of components to optimize
   */
   virtual void optimizeCADLoops(const SceneI::OccurrenceList & occurrences) final ;

   //! Optimize mesh for rendering (lossless, only reindexing)
   /*!
     \param occurrences Occurrences of components to optimize
   */
   virtual void optimizeForRendering(const SceneI::OccurrenceList & occurrences) final ;

   //! Sort sub meshes by materials
   /*!
     \param occurrences Part occurrencess to process
   */
   virtual void optimizeSubMeshes(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     ...
     \param texelPerMm Number of texel per millimeter in a 3D space
   */
   virtual void optimizeTextureSize(const SceneI::Occurrence & root, const CoreI::Double & texelPerMm) final ;
   ...
   */
   virtual void removeHoles(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & throughHoles, const CoreI::Boolean & blindHoles, const CoreI::Boolean & surfacicHoles, const GeomI::Distance & maxDiameter, const MaterialI::Material & fillWithMaterial = 0) final ;
   ...
   */
   virtual void repairCAD(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & tolerance, const CoreI::Boolean & orient = true) final ;
   ...
   /*!
     ...
     \param maxIndex 
   */
   virtual void setFeatureComponentMaxIndex(const SceneI::OccurrenceList & occurrences, const CoreI::Int & maxIndex) final ;
   ...
   */
   virtual void smoothMesh(const SceneI::OccurrenceList & occurrences, const CostEvaluation & mode, const CoreI::Int & maxIterations = 100, const CoreI::Boolean & lockSignificantEdges = true) final ;

   /*!
     \param occurrences Input occurrences
   */
   virtual void splitUVForAtlas(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     ...
     \param generateUV 
   */
   virtual void sweep(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & radius, const CoreI::Int & sides, const CoreI::Boolean & createNormals, const CoreI::Boolean & keepLines, const CoreI::Boolean & generateUV) final ;
   ...
   */
   virtual void tessellatePointClouds(const SceneI::OccurrenceList & occurrences, const CoreI::Int & kNeighbors = 20, const CoreI::Boolean & keepPoints = false, const CoreI::Boolean & colorize = true) final ;
   ...
   */
   ...
   /*!
     ...
     \param voxelSize Size of voxels
   */
   virtual void voxelizePointClouds(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize = 500) final ;
   ...
   /*!
     ...
     \param tolerance Tolerance when point is projected on seam (if the model come from a decimation it is recommended to use the lineic tolerance here)
   */
   virtual void bakeUV(const SceneI::Occurrence & source, const SceneI::Occurrence & destination, const CoreI::Int & sourceChannel = 0, const CoreI::Int & destinationChannel = 0, const GeomI::Distance & tolerance = 0.001) final ;
   ...
   */
   virtual void combineMaterials(const SceneI::OccurrenceList & occurrences, const BakeOption & bakingOptions, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & singularizeOnAO = false) final ;
   ...
   /*!
     ...
     \return occurrence 
   */
   virtual SceneI::Occurrence combineMeshes(const SceneI::OccurrenceList & occurrences, const BakeOption & bakingOptions, const CoreI::Boolean & overrideExistingUVs = false) final ;
   ...
   */
   virtual SceneI::OccurrenceList convexDecomposition(const SceneI::OccurrenceList & occurrences, const CoreI::Int & maxCount, const CoreI::Int & vertexCount, const CoreI::Boolean & approximate, const CoreI::Int & resolution = 100000, const CoreI::Double & concavity = 0.001) final ;
   ...
   */
   virtual void explodeBodies(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & groupOpenShells = false) final ;

   //! Explode all parts by material. New parts will be placed as children of input part occurrences.
   /*!
     \param occurrences Part occurrences to process
   */
   virtual void explodeByMaterials(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void explodeByVertexCount(const SceneI::OccurrenceList & occurrences, const CoreI::Int & maxVertexCount, const CoreI::Int & maxTriangleCount, const CoreI::Boolean & countMergedVerticesOnce = true) final ;
   ...
   */
   virtual void explodeByVoxel(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize) final ;

   //! Explode connected set of polygons to part occurrences. New parts will be placed as children of input part occurrences.
   /*!
     \param occurrences Part occurrences to process
   */
   virtual void explodeConnectedMeshes(const SceneI::OccurrenceList & occurrences) final ;

   //! Explode all parts by patch
   /*!
     \param occurrences Part occurrences to process
   */
   virtual void explodePatches(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     \param root The model root occurrence
     \param bricks 
     \param colors 
     \param density 
     \param forceFillingWithSmallBricks 
     \return decomposition The root occurrence of the decomposition and the list of bricks used
   */
   virtual LegoReturn legoDecomposition(const SceneI::Occurrence & root, const CADI::LegoBrickDefinitionList & bricks, const CoreI::ColorList & colors, const CoreI::Int & density = 100, const CoreI::Boolean & forceFillingWithSmallBricks = true) final ;
   ...
   */
   virtual void createVisibilityInformation(const SceneI::OccurrenceList & occurrences, const SelectionLevel & level, const CoreI::Int & resolution, const CoreI::Int & sphereCount, const CoreI::Double & fovX = 90, const CoreI::Boolean & considerTransparentOpaque = false, const SceneI::Occurrence & root = 0) final ;
   ...
   */
   virtual SceneI::OccurrenceList findOccludedPartOccurrences(const SceneI::OccurrenceList & occurrences, const CoreI::Int & resolution, const CoreI::Int & sphereCount, const CoreI::Double & fovX = 90, const CoreI::Boolean & considerTransparentOpaque = false, const SceneI::Occurrence & root = 0) final ;
   ...
   */
   virtual SceneI::Occurrence createOcclusionMesh(const SceneI::OccurrenceList & occurrences, const CreateOccluder & type, const GeomI::Distance & voxelSize, const CoreI::Int & gap) final ;

   //! Replace the tessellations of the selected parts by a retopology based on a dual-contouring
   /*!
     \param occurrences Part occurrences to process
     \param minFixedDepth Minimum depth of the octree for removing inside parts
     \param maxDepth Maximum depth of the octree for the dual-contouring (defines the minimum polygon size)
     ...
     \param aabb AABB to use for the root of the octree
     \return dualContouredPart Resulting part occurrence
   */
   virtual SceneI::Occurrence dualContouring(const SceneI::OccurrenceList & occurrences, const CoreI::Int & minFixedDepth, const CoreI::Int & maxDepth, const CoreI::Double & tolerance, const CoreI::Boolean & sameSizeOnAllAxis, const GeomI::AABB & aabb) final ;
   ...
   /*!
     ...
     \return dualContouredPart Resulting part occurrence
   */
   virtual SceneI::Occurrence dualContouringTarget(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & filteringSize, const GeomI::Distance & voxelSize, const CoreI::Double & tolerance, const CoreI::Boolean & sameSizeOnAllAxis) final ;
   ...
   */
   virtual SceneI::Occurrence marchingCubes(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize, const ElementFilter & elements = ElementFilter::Polygons, const CoreI::Int & dilation = 0, const CoreI::Boolean & surfacic = false) final ;
   ...
   */
   virtual SceneI::Occurrence proxyMesh(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize, const ElementFilter & elements = ElementFilter::Polygons, const CoreI::Int & dilation = 0, const CoreI::Boolean & surfacic = false) final ;
   ...
   */
   virtual SceneI::Occurrence retopologize(const SceneI::OccurrenceList & occurrences, const CoreI::Int & targetTriangleCount, const CoreI::Bool & pureQuad, const CoreI::Bool & pointCloud, const GeomI::Distance & precision = -1) final ;
   ...
   */
   virtual SceneI::Occurrence voxelize(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize, const ElementFilter & elements = ElementFilter::Polygons, const CoreI::Int & dilation = 0, const CoreI::Boolean & useCurrentAnimationPosition = false) final ;
   ...
   */
   virtual void replaceBy(const SceneI::OccurrenceList & occurrences, const ReplaceByOption & replaceBy) final ;
   ...
   */
   virtual void replaceByBox(const SceneI::OccurrenceList & occurrences, const ReplaceByBoxType & boxType) final ;

   //! Replace objects by convex hull
   /*!
     \param occurrences Occurrences of components to replace
   */
   virtual void replaceByConvexHull(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void replaceByPrimitive(const SceneI::OccurrenceList & occurrences, const PrimitiveShapeParameters & primitive, const CoreI::Boolean & generateUV = true) final ;
   ...
   */
   virtual void sawWithAABB(const SceneI::OccurrenceList & occurrences, const GeomI::AABB & aabb, const SawingMode & mode, const CoreI::String & innerSuffix = "_inner", const CoreI::String & outerSuffix = "_outer") final ;
   ...
   /*!
     ...
     \param outerSuffix Only if mode is set to SawAndSplit, set the suffix of the outer part
   */
   virtual void sawWithOBB(const SceneI::OccurrenceList & occurrences, const GeomI::OBB & obb, const SawingMode & mode, const CoreI::String & innerSuffix = "_inner", const CoreI::String & outerSuffix = "_outer") final ;
   ...
   */
   virtual SceneI::Occurrence sawWithOctree(const SceneI::OccurrenceList & occurrences, const GeomI::AABB & aabb, const CoreI::Int & maxDepth, const CoreI::Int & maxTrianglesByLeaf = -1, const CoreI::Double & sawTolerance = 0) final ;
   ...
   */
   virtual void sawWithPlane(const SceneI::OccurrenceList & occurrences, const GeomI::Point3 & planeOrigin, const GeomI::Vector3 & planeNormal, const SawingMode & mode, const CoreI::String & innerSuffix = "_inner", const CoreI::String & outerSuffix = "_outer", const CoreI::Double & tolerance = 0) final ;
   ...
   */
   virtual SceneI::OccurrenceList findSimilarPartOccurrencesFast(const SceneI::OccurrenceList & occurrences, const CoreI::Coeff & dimensionsSimilarity, const CoreI::Coeff & polycountSimilarity, const CoreI::Boolean & ignoreSymmetry) final ;
   ...
   */
   virtual void alignUVIslands(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Double & usePolygonsWeights = 0, const CoreI::Double & useVerticesWeights = 0, const AlignmentMode & alignmentMode = AlignmentMode::Auto) final ;
   ...
   */
   virtual void applyUvTransform(const SceneI::OccurrenceList & occurrences, const GeomI::Matrix4 & matrix, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual void automaticUVMapping(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Double & maxAngleDistorsion = 0.5, const CoreI::Double & maxAreaDistorsion = -1, const CoreI::Bool & sharpToSeam = true, const CoreI::Bool & forbidOverlapping = true) final ;
   ...
   */
   virtual void copyUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & sourceChannel = 0, const CoreI::Int & destinationChannel = 0) final ;
   ...
   */
   virtual void defragmentUVIslands(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel, const CoreI::Int & targetIslandCount = 0, const CoreI::Double & energyThreshold = 0.01, const CoreI::Boolean & forceIsolatedFaces = true) final ;
   ...
   /*!
     ...
     \param newtonTolf Threshold for gradient normals
     \param newtonTolx Threshold for gradient normals
   */
   virtual void flattenUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Int & iterations = 1, const CoreI::Double & newtonTolf = 1.0, const CoreI::Double & newtonTolx = 1.0) final ;
   ...
   */
   virtual CoreI::DoubleList getRatioUV3D(const SceneI::OccurrenceList & occurrences, const RatioUV3DMode & ratioMode, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual getUVQualityMetricsReturn getUVQualityMetrics(const SceneI::OccurrenceList & occurrences, const CoreI::UInt & channel) final ;
   ...
   */
   virtual GeomI::AABR getUvAabr(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual void mapUvOnAABB(const SceneI::OccurrenceList & occurrences, const CoreI::Bool & useLocalAABB, const GeomI::Distance & uv3dSize, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & ignoreScale = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnBox(const SceneI::OccurrenceList & occurrences, const Box & box, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnCubicAABB(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & uv3dSize, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnCustomAABB(const SceneI::OccurrenceList & occurrences, const GeomI::AABB & aabb, const GeomI::Distance & uv3dSize, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnCylinder(const SceneI::OccurrenceList & occurrences, const Cylinder & cylinder, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   */
   virtual void mapUvOnFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & useAABB = true) final ;
   ...
   /*!
     ...
     \param useAABB If true use for the fitting the global Axis Aligned Bounding Box (AABB), else use a Minimum Bounding Box (MBB only based on transformed AABB of occurrences)
   */
   virtual void mapUvOnFittingSphere(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & useAABB = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnMBB(const SceneI::OccurrenceList & occurrences, const CoreI::Bool & useLocalMBB, const GeomI::Distance & uv3dSize, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnPlane(const SceneI::OccurrenceList & occurrences, const Plane & plane, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param overrideExistingUVs If True, override existing UVs on channel
   */
   virtual void mapUvOnSphere(const SceneI::OccurrenceList & occurrences, const Sphere & sphere, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true) final ;
   ...
   /*!
     ...
     \param maxTransformationType Maximum transformation allowed: TRS only, affine and perspective
     \param allowUVInversion Allow merged UVs to be inverted
   */
   virtual void mergeUVIslands(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Double & scaleWeights = 0, const CoreI::Double & maxScaleVariationFactor = 1.2, const CoreI::Double & curvatureWeights = -1, const CoreI::Double & usePolygonsWeights = 1, const CoreI::Double & useVerticesWeights = -1, const MaxTransformationType & maxTransformationType = MaxTransformationType::Similarity, const CoreI::Boolean & allowUVInversion = false) final ;
   ...
   */
   virtual void normalizeUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & sourceUVChannel, const CoreI::Int & destinationUVChannel = -1, const CoreI::Boolean & uniform = true, const CoreI::Boolean & sharedUVSpace = true, const CoreI::Boolean & ignoreNullIslands = false) final ;
   ...
   */
   virtual void relaxUV(const SceneI::OccurrenceList & occurrences, const RelaxUVMethod & method, const CoreI::Int & iterations = 100, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual void removeUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = -1) final ;
   ...
   */
   ...
   /*!
     ...
     \param channel UV channel to use
   */
   virtual void resizeUVsToTextureSize(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & TextureSize, const CoreI::Int & channel = 0) final ;
   ...
   /*!
     ...
     \param channel UV channel to transform
   */
   virtual void scaleUV(const SceneI::OccurrenceList & occurrences, const CoreI::Double & scaleU, const CoreI::Double & scaleV, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual void smoothUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & iterations = 1, const CoreI::Int & channel = 0) final ;
   ...
   */
   virtual void swapUvChannels(const SceneI::OccurrenceList & occurrences, const CoreI::Int & firstChannel, const CoreI::Int & secondChannel) final ;
   ...
   */
   virtual void transferVisibilityToPolygonalWeight(const SceneI::OccurrenceList & occurrences, const VisibilityToWeightMode & Mode) final ;
   ...
   */
   virtual GeomI::Affine getFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & useAABB = true) final ;
   ...
   */
   virtual GeomI::Affine getFittingSphere(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & useAABB = true) final ;
   ...
   */
   ...
   /*!
     \param normalMap Source normal map to convert
   */
   virtual void fillNormalMap(const MaterialI::Image & normalMap) final ;

   //! Orient a tangent space normal map (all Z positive)
   /*!
     \param normalMap Normal map to orient
   */
   virtual void orientNormalMap(const MaterialI::Image & normalMap) final ;
   ...
   */
   virtual void barySmooth(const SceneI::OccurrenceList & occurrences, const CoreI::Int & iteration) final ;
   ...
   */
   virtual void crackMoebiusStrips(const SceneI::OccurrenceList & occurrences, const CoreI::Int & maxEdgeCount = 3) final ;

   //! Splits non-manifold vertices
   /*!
     \param occurrences Occurrences of components to repair
   */
   virtual void crackNonManifoldVertices(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual SceneI::Occurrence createCavityOccurrences(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & voxelSize, const GeomI::Volume & minimumCavityVolume, const InnerOuterOption & mode = InnerOuterOption::All, const SceneI::Occurrence & parent = SceneI::Occurrence()) final ;

   //! Invert the orientation of tessellation elements
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void invertPolygonFacesOrientation(const SceneI::OccurrenceList & occurrences) final ;

   //! Splits moebius ring
   /*!
     \param occurrences Occurrences of components to repair
   */
   virtual void moebiusCracker(const SceneI::OccurrenceList & occurrences) final ;

   //! Orient existing normal according to the polygons clockwise
   /*!
     \param occurrences Occurrences of components to orient normals
   */
   virtual void orientNormals(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void remeshSurfacicHoles(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDiameter) final ;
   ...
   */
   virtual void removeDegeneratedPolygons(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & tolerance) final ;

   //! Remove multiple polygon
   /*!
     \param occurrences Occurrences of components to repair
   */
   virtual void removeMultiplePolygon(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual GeomI::Distance removeZFighting(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     ...
     \param orient If true reorient the model
   */
   virtual void repairMesh(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & tolerance, const CoreI::Bool & crackNonManifold = true, const CoreI::Boolean & orient = true) final ;
   ...
   */
   virtual void repairNullNormals(const SceneI::OccurrenceList & occurrences) final ;

   //! Remove non manifold edges and try to reconnect manifold groups of triangles
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void separateToManifold(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void sewBoundary(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDistance) final ;
   ...
   */
   virtual void vertexOffset(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & offset) final ;
   ...
   virtual void orientFromFace() final ;
   ...
   */
   virtual void orientPolygonFaces(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & makeOrientable = true, const CoreI::Boolean & useArea = false, const OrientStrategy & orientStrategy = OrientStrategy::ExteriorOnly) final ;
   ...
   */
   ...
   /*!
     ...
     \param fovX Horizontal field of view (in degree)
   */
   virtual void orientPolygonFacesFromCamera(const SceneI::OccurrenceList & occurrences, const GeomI::Point3 & cameraPosition, const GeomI::Point3 & cameraDirection, const GeomI::Point3 & cameraUp, const CoreI::Int & resolution, const CoreI::Double & fovX = 90) final ;
   ...
   /*!
     ...
     \param maxIterations Maximum number of swapping iteration
   */
   virtual void equilateralize(const SceneI::OccurrenceList & occurrences, const CoreI::Int & maxIterations = 1) final ;

   //! Merge all triangle polygons in the meshes to quadrangles
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void quadify(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void requadify(const SceneI::OccurrenceList & occurrences, const CoreI::Bool & forceFullQuad = true) final ;

   //! Convert all static mesh to editable mesh
   /*!
     \param occurrences Occurrences to convert to editable mesh
   */
   virtual void toEditableMesh(const SceneI::OccurrenceList & occurrences) final ;

   //! Convert all editable mesh to static mesh
   /*!
     \param occurrences Occurrences to convert to static mesh
   */
   virtual void toStaticMesh(const SceneI::OccurrenceList & occurrences) final ;

   //! Split all non-triangle polygons in the meshes to triangles
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void triangularize(const SceneI::OccurrenceList & occurrences) final ;
   ...
   */
   virtual void createVertexWeightsFromVertexColors(const SceneI::OccurrenceList & occurrences, const CoreI::Double & offset = 0, const CoreI::Double & scale = 1) final ;
   ...
   /*!
     ...
     \param scale Scale value for weight computation
   */
   virtual void createVertexWeightsFromVisibilityAttributes(const SceneI::OccurrenceList & occurrences, const CoreI::Double & offset = 0, const CoreI::Double & scale = 1) final ;

   //! Remove any existing vertex weights attributes on given occurrences
   /*!
     \param occurrences Occurrences of components to process
   */
   virtual void deleteVertexWeights(const SceneI::OccurrenceList & occurrences) final ;
   ...
   /*!
     \param occurrences Occurrences of components to create attributes
   */
   virtual void createVisibilityAttributes(const SceneI::OccurrenceList & occurrences) final ;

   //! Delete visibility attributes on tessellations
   /*!
     \param occurrences Occurrences of components to delete attributes
   */
   virtual void deleteVisibilityAttributes(const SceneI::OccurrenceList & occurrences) final ;

   //! Add one count to all visiblility attributes (poly and patch) on transparent patches
   /*!
     \param occurrences Occurrences of components to create attributes
   */
   virtual void flagVisibilityAttributesOnTransparents(const SceneI::OccurrenceList & occurrences) final ;

   /**@}*/

private:
   friend class PiXYZ::PiXYZAPI;
   AlgoInterface(void * session);
   void * _session;
};
