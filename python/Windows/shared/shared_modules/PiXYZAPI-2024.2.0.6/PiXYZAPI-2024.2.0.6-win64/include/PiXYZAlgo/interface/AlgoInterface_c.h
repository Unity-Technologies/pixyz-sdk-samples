...
PXZ_EXPORTED void Algo_decimateTarget(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_DecimateOptionsSelector targetStrategy, Algo_UVImportanceEnum UVImportance, Core_Boolean protectTopology, Core_ULong iterativeThreshold, Core_Boolean processMeshIndependently);
...
PXZ_EXPORTED void Algo_filletMesh(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Double value, Algo_FilletingMode filletingMode, Core_Int subdivisionNb, Core_Boolean createFlatChamfer, Material_Material material);
...
PXZ_EXPORTED Geom_Point3ListList Algo_meshIntersections(Session * pxzSession, Scene_Occurrence occurrence1, Scene_Occurrence occurrence2);
...
PXZ_EXPORTED void Algo_bakeUV(Session * pxzSession, Scene_Occurrence source, Scene_Occurrence destination, Core_Int sourceChannel, Core_Int destinationChannel, Geom_Distance tolerance);
...
// Combine all given meshes to one mesh with one material (baked)
PXZ_EXPORTED Scene_Occurrence Algo_combineMeshes(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_BakeOption bakingOptions, Core_Boolean overrideExistingUVs);
...
PXZ_EXPORTED void Algo_explodeConnectedMeshes(Session * pxzSession, Scene_OccurrenceList occurrences);
...
PXZ_EXPORTED Algo_LegoReturn Algo_legoDecomposition(Session * pxzSession, Scene_Occurrence root, CAD_LegoBrickDefinitionList bricks, Core_ColorList colors, Core_Int density, Core_Boolean forceFillingWithSmallBricks);
...
PXZ_EXPORTED void Algo_createVisibilityInformation(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_SelectionLevel level, Core_Int resolution, Core_Int sphereCount, Core_Double fovX, Core_Boolean considerTransparentOpaque, Scene_Occurrence root);
// Create visilibity information on part occurrences viewed from a set of voxel based view points.
PXZ_EXPORTED void Algo_createVisibilityInformationAdvanced(Session * pxzSession, Scene_OccurrenceList occurrences, Geom_Distance voxelSize, Geom_Volume minimumCavityVolume, Core_Int resolution, Algo_InnerOuterOption mode, Core_Boolean considerTransparentOpaque, Scene_Occurrence root);
...
PXZ_EXPORTED Scene_OccurrenceList Algo_findOccludedPartOccurrences(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int resolution, Core_Int sphereCount, Core_Double fovX, Core_Boolean considerTransparentOpaque, Scene_Occurrence root);
...
PXZ_EXPORTED Core_BoolList Algo_removeOccludedGeometries(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_SelectionLevel level, Core_Int resolution, Core_Int sphereCount, Core_Double fovX, Core_Boolean considerTransparentOpaque, Core_Int adjacencyDepth, Scene_Occurrence root);
// Delete part occurrences, patches or polygons not seen from voxel based view points.
PXZ_EXPORTED Core_BoolList Algo_removeOccludedGeometriesAdvanced(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_SelectionLevel level, Geom_Distance voxelSize, Geom_Volume minimumCavityVolume, Core_Int resolution, Algo_InnerOuterOption mode, Core_Boolean considerTransparentOpaque, Core_Int adjacencyDepth, Scene_Occurrence root);
// Delete part occurrences, patches or polygons not viewed from spheres generated with a set of camera position
PXZ_EXPORTED Core_BoolList Algo_removeOccludedGeometriesFromPoints(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_SelectionLevel level, Geom_Point3List positions, Core_Int resolution, Core_Int sphereCount, Core_Double fovX, Core_Boolean considerTransparentOpaque, Core_Int adjacencyDepth, Scene_Occurrence root);
// Delete part occurrences, patches or polygons not viewed from a set of camera position/orientation
PXZ_EXPORTED Core_BoolList Algo_removeOccludedGeometriesFromViewPoints(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_SelectionLevel level, Geom_Point3List positions, Geom_Point3List directions, Geom_Point3List ups, Core_Int resolution, Core_Double fovX, Core_Boolean considerTransparentOpaque, Core_Int adjacencyDepth, Scene_Occurrence root);
...
PXZ_EXPORTED Scene_Occurrence Algo_dualContouring(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int minFixedDepth, Core_Int maxDepth, Core_Double tolerance, Core_Boolean sameSizeOnAllAxis, Geom_AABB aabb);
...
PXZ_EXPORTED Scene_Occurrence Algo_dualContouringTarget(Session * pxzSession, Scene_OccurrenceList occurrences, Geom_Distance filteringSize, Geom_Distance voxelSize, Core_Double tolerance, Core_Boolean sameSizeOnAllAxis);
...
PXZ_EXPORTED void Algo_automaticUVMapping(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int channel, Core_Double maxAngleDistorsion, Core_Double maxAreaDistorsion, Core_Bool sharpToSeam, Core_Bool forbidOverlapping);
...
PXZ_EXPORTED void Algo_defragmentUVIslands(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int channel, Core_Int targetIslandCount, Core_Double energyThreshold, Core_Boolean forceIsolatedFaces);
// Flatten the UVs on the occurrence
PXZ_EXPORTED void Algo_flattenUV(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int channel, Core_Int iterations, Core_Double newtonTolf, Core_Double newtonTolx);
...
PXZ_EXPORTED void Algo_mapUvOnFittingCylinder(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int channel, Core_Boolean overrideExistingUVs, Core_Boolean useAABB);
...
PXZ_EXPORTED void Algo_mergeUVIslands(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int channel, Core_Double scaleWeights, Core_Double maxScaleVariationFactor, Core_Double curvatureWeights, Core_Double usePolygonsWeights, Core_Double useVerticesWeights, Algo_MaxTransformationType maxTransformationType, Core_Boolean allowUVInversion);
...
// Relax UVs
PXZ_EXPORTED void Algo_relaxUV(Session * pxzSession, Scene_OccurrenceList occurrences, Algo_RelaxUVMethod method, Core_Int iterations, Core_Int channel);
...
PXZ_EXPORTED void Algo_smoothUV(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Int iterations, Core_Int channel);
...
PXZ_EXPORTED Geom_Affine Algo_getFittingCylinder(Session * pxzSession, Scene_OccurrenceList occurrences, Core_Boolean useAABB);
...
PXZ_EXPORTED void Algo_remeshSurfacicHoles(Session * pxzSession, Scene_OccurrenceList occurrences, Geom_Distance maxDiameter);
...
PXZ_EXPORTED void Algo_toEditableMesh(Session * pxzSession, Scene_OccurrenceList occurrences);
// Convert all editable mesh to static mesh
PXZ_EXPORTED void Algo_toStaticMesh(Session * pxzSession, Scene_OccurrenceList occurrences);
