...
public:
   ...
   */
   virtual void filletMesh(const SceneI::OccurrenceList & occurrences, const CoreI::Double & value, const FilletingMode & filletingMode = FilletingMode::Width, const CoreI::Int & subdivisionNb = 0, const CoreI::Boolean & createFlatChamfer = false, const MaterialI::Material & material = MaterialI::Material()) = 0;
   ...
   */
   virtual GeomI::Point3ListList meshIntersections(const SceneI::Occurrence & occurrence1, const SceneI::Occurrence & occurrence2) = 0;
   ...
   */
   virtual void bakeUV(const SceneI::Occurrence & source, const SceneI::Occurrence & destination, const CoreI::Int & sourceChannel = 0, const CoreI::Int & destinationChannel = 0, const GeomI::Distance & tolerance = 0.001) = 0;
   ...
   */
   ...
   /*!
     ...
     \return occurrence 
   */
   virtual SceneI::Occurrence combineMeshes(const SceneI::OccurrenceList & occurrences, const BakeOption & bakingOptions, const CoreI::Boolean & overrideExistingUVs = false) = 0;
   ...
   */
   ...
   /*!
     \param occurrences Part occurrences to process
   */
   virtual void explodeConnectedMeshes(const SceneI::OccurrenceList & occurrences) = 0;
   ...
   */
   virtual LegoReturn legoDecomposition(const SceneI::Occurrence & root, const CADI::LegoBrickDefinitionList & bricks, const CoreI::ColorList & colors, const CoreI::Int & density = 100, const CoreI::Boolean & forceFillingWithSmallBricks = true) = 0;
   ...
   */
   virtual void createVisibilityInformation(const SceneI::OccurrenceList & occurrences, const SelectionLevel & level, const CoreI::Int & resolution, const CoreI::Int & sphereCount, const CoreI::Double & fovX = 90, const CoreI::Boolean & considerTransparentOpaque = false, const SceneI::Occurrence & root = 0) = 0;
   ...
   */
   virtual SceneI::OccurrenceList findOccludedPartOccurrences(const SceneI::OccurrenceList & occurrences, const CoreI::Int & resolution, const CoreI::Int & sphereCount, const CoreI::Double & fovX = 90, const CoreI::Boolean & considerTransparentOpaque = false, const SceneI::Occurrence & root = 0) = 0;
   ...
   */
   virtual SceneI::Occurrence dualContouring(const SceneI::OccurrenceList & occurrences, const CoreI::Int & minFixedDepth, const CoreI::Int & maxDepth, const CoreI::Double & tolerance, const CoreI::Boolean & sameSizeOnAllAxis, const GeomI::AABB & aabb) = 0;
   ...
   /*!
     ...
     \return dualContouredPart Resulting part occurrence
   */
   virtual SceneI::Occurrence dualContouringTarget(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & filteringSize, const GeomI::Distance & voxelSize, const CoreI::Double & tolerance, const CoreI::Boolean & sameSizeOnAllAxis) = 0;
   ...
   */
   virtual void automaticUVMapping(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Double & maxAngleDistorsion = 0.5, const CoreI::Double & maxAreaDistorsion = -1, const CoreI::Bool & sharpToSeam = true, const CoreI::Bool & forbidOverlapping = true) = 0;
   ...
   */
   virtual void defragmentUVIslands(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel, const CoreI::Int & targetIslandCount = 0, const CoreI::Double & energyThreshold = 0.01, const CoreI::Boolean & forceIsolatedFaces = true) = 0;
   ...
   */
   virtual void flattenUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Int & iterations = 1, const CoreI::Double & newtonTolf = 1.0, const CoreI::Double & newtonTolx = 1.0) = 0;
   ...
   */
   virtual void mapUvOnFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & useAABB = true) = 0;
   ...
   */
   virtual void relaxUV(const SceneI::OccurrenceList & occurrences, const RelaxUVMethod & method, const CoreI::Int & iterations = 100, const CoreI::Int & channel = 0) = 0;
   ...
   */
   virtual void smoothUV(const SceneI::OccurrenceList & occurrences, const CoreI::Int & iterations = 1, const CoreI::Int & channel = 0) = 0;
   ...
   */
   virtual GeomI::Affine getFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & useAABB = true) = 0;
   ...
   */
   virtual void barySmooth(const SceneI::OccurrenceList & occurrences, const CoreI::Int & iteration) = 0;
   ...
   */
   virtual void remeshSurfacicHoles(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDiameter) = 0;
   ...
   */
   virtual void vertexOffset(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & offset) = 0;
   ...
   */
   virtual void toEditableMesh(const SceneI::OccurrenceList & occurrences) = 0;

   //! Convert all editable mesh to static mesh
   /*!
     \param occurrences Occurrences to convert to static mesh
   */
   virtual void toStaticMesh(const SceneI::OccurrenceList & occurrences) = 0;
