...
public:
   ...
   */
   virtual Body createRevolveExtrusion(const CurveList & profileCurves, const GeomI::Point3 & center, const GeomI::Vector3 & direction, const CoreI::Double & angle, const CoreI::Bool & area) = 0;
   ...
   */
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createLegoBrick(const LegoBrickDefinition & brickDefinition) = 0;
   ...
   */
   virtual void setEdgeStyle(const Edge & edge, const EdgeStyle & style) = 0;
   ...
   */
   virtual CoEdge createCoEdge(const Edge & edge, const GeomI::Orientation & orientation, const Surface & surface = 0, const Curve & curve2D = 0) = 0;
   ...
   */
   virtual Loop createLoop(const CoEdgeList & coEdges, const CoreI::Boolean & check = true) = 0;
   ...
   */
   virtual void invertFaces(const FaceList & faces) = 0;
   ...
   */
   virtual Surface createConeSurface(const GeomI::Distance & radius, const GeomI::Angle & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createCurveExtrusionSurface(const Curve & generatrixCurve, const Curve & directrixCurve, const Surface & refSurface) = 0;
   ...
   */
   virtual Surface createEllipticConeSurface(const GeomI::Distance & radius1, const GeomI::Distance & radius2, const GeomI::Angle & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createRevolutionSurface(const Curve & generatrixCurve, const GeomI::Point3 & axisOrigin, const GeomI::Vector3 & axisDirection, const GeomI::Angle & startAngle = 0, const GeomI::Angle & endAngle = 360.0) = 0;
