...
struct AliasTypeDesc {
   String alias;
   AliasTypeDesc(String _alias = "") : alias(_alias) {}
};

struct ArrayTypeDesc {
   String arrayType;
   Int size;
   ArrayTypeDesc(String _arrayType = "", Int _size = 0) : arrayType(_arrayType), size(_size) {}
};
...
struct BoundedInteger {
   ...
   Int min;
   Int max;
   BoundedInteger(Int _value = 0, Int _min = 0, Int _max = 0) : value(_value), min(_min), max(_max) {}
};
...
struct EnumTypeDesc {
   ...
   StringList labels;
   String valueType;
   EnumTypeDesc(IntList _values = IntList(), StringList _labels = StringList(), String _valueType = "") : values(_values), labels(_labels), valueType(_valueType) {}
};

struct ListTypeDesc {
   String listType;
   ListTypeDesc(String _listType = "") : listType(_listType) {}
};
...
struct StructTypeDesc {
   FieldList fields;
   StructTypeDesc(FieldList _fields = FieldList()) : fields(_fields) {}
};
...
struct SelType {
   ...
   String defaultValue;
   String description;
   SelType(String _name = "", String _type = "", String _defaultValue = "", String _description = "") : name(_name), type(_type), defaultValue(_defaultValue), description(_description) {}
};
...
struct SelectTypeDesc {
   SelTypeList types;
   SelectTypeDesc(SelTypeList _types = SelTypeList()) : types(_types) {}
};
...
struct TypeDesc {
   ...
   TypeDesc(String _name = "", String _module = "", TypeDescType _type = TypeDescType::UNKNOWN, String _description = "", TypeDescDef _definition = TypeDescDef()) : name(_name), module(_module), type(_type), description(_description), definition(_definition) {}
};
...
struct ConstantDesc {
   ...
   TypeDesc type;
   String description;
   ConstantDesc(String _name = "", String _value = "", TypeDesc _type = TypeDesc(), String _description = "") : name(_name), value(_value), type(_type), description(_description) {}
};
...
struct EnumPropertyInfo {
   ...
   IntList values;
   StringList labels;
   EnumPropertyInfo(String _name = "", IntList _values = IntList(), StringList _labels = StringList()) : name(_name), values(_values), labels(_labels) {}
};
...
struct ParameterDesc {
   ...
   ParameterDesc(String _name = "", TypeDesc _type = TypeDesc(), String _description = "", Bool _optional = false, String _defaultValue = "", String _disableValue = "", StringPairList _attributes = StringPairList()) : name(_name), type(_type), description(_description), optional(_optional), defaultValue(_defaultValue), disableValue(_disableValue), attributes(_attributes) {}
};
...
struct Format {
   ...
   Format(String _name = "", StringList _extensions = StringList()) : name(_name), extensions(_extensions) {}
};
...
struct ModuleDesc {
   ...
   Stability stability;
   ModuleDesc(String _name = "", String _description = "", String _author = "", GroupDescList _groups = GroupDescList(), TypeDescList _types = TypeDescList(), ConstantDescList _constants = ConstantDescList(), StringList _dependencies = StringList(), Stability _stability = Stability::STABLE) : name(_name), description(_description), author(_author), groups(_groups), types(_types), constants(_constants), dependencies(_dependencies), stability(_stability) {}
};
