...
public:
   ...
   */
   ...
   virtual void softStopAsyncEventManager() = 0;
   ...
   */
   ...
   /*!
     ...
     \param data 
   */
   virtual void parallelAddJob(const ParallelSession & session, ParallelCallback jobCallback, const Ptr & data) = 0;
   ...
   */
   virtual OutputFilePath getOutputFilePath(const String & fileName, const String & data = "none") = 0;
   ...
   */
   virtual void removeDirectory(const DirectoryPath & path) = 0;
   ...
   virtual void endUndoRedoStep() = 0;
   ...
   */
   ...
   /*!
     \param stepName 
   */
   virtual void startUndoRedoStep(const String & stepName) = 0;
   ...
   */
   virtual Color getColorFromIndex(const Int & index) = 0;
