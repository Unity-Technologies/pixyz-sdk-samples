...
struct Point3 {
   ...
   CoreI::Double y;
   CoreI::Double z;
   Point3(CoreI::Double _x = 0, CoreI::Double _y = 0, CoreI::Double _z = 0) : x(_x), y(_y), z(_z) {}
};

struct AABB {
   Point3 low;
   Point3 high;
   AABB(Point3 _low = Point3(), Point3 _high = Point3()) : low(_low), high(_high) {}
};

struct Point2 {
   CoreI::Double x;
   CoreI::Double y;
   Point2(CoreI::Double _x = 0, CoreI::Double _y = 0) : x(_x), y(_y) {}
};

struct AABR {
   Point2 low;
   Point2 high;
   AABR(Point2 _low = Point2(), Point2 _high = Point2()) : low(_low), high(_high) {}
};
...
struct Affine {
   ...
   Vector3 yAxis;
   Vector3 zAxis;
   Affine(Point3 _origin = Point3(), Vector3 _xAxis = Vector3(), Vector3 _yAxis = Vector3(), Vector3 _zAxis = Vector3()) : origin(_origin), xAxis(_xAxis), yAxis(_yAxis), zAxis(_zAxis) {}
};
...
struct Curvatures {
   ...
   Vector3 v1;
   Vector3 v2;
   Curvatures(CoreI::Double _k1 = 0, CoreI::Double _k2 = 0, Vector3 _v1 = Vector3(), Vector3 _v2 = Vector3()) : k1(_k1), k2(_k2), v1(_v1), v2(_v2) {}
};
...
struct ExtendedBox {
   ...
   Distance extentY;
   Distance extentZ;
   ExtendedBox(Point3 _position = Point3(), Distance _extentX = 1, Distance _extentY = 1, Distance _extentZ = 1) : position(_position), extentX(_extentX), extentY(_extentY), extentZ(_extentZ) {}
};
...
struct OBB {
   ...
   Vector3 yAxis;
   Vector3 zAxis;
   OBB(Point3 _corner = Point3(), Vector3 _xAxis = Vector3(), Vector3 _yAxis = Vector3(), Vector3 _zAxis = Vector3()) : corner(_corner), xAxis(_xAxis), yAxis(_yAxis), zAxis(_zAxis) {}
};
...
struct Point4 {
   ...
   CoreI::Double z;
   CoreI::Double w;
   Point4(CoreI::Double _x = 0, CoreI::Double _y = 0, CoreI::Double _z = 0, CoreI::Double _w = 0) : x(_x), y(_y), z(_z), w(_w) {}
};
...
struct Ray {
   Point3 origin;
   Vector3 direction;
   Ray(Point3 _origin = Point3(), Vector3 _direction = Vector3()) : origin(_origin), direction(_direction) {}
};
...
struct Vector4I {
   ...
   CoreI::Int z;
   CoreI::Int w;
   Vector4I(CoreI::Int _x = 0, CoreI::Int _y = 0, CoreI::Int _z = 0, CoreI::Int _w = 0) : x(_x), y(_y), z(_z), w(_w) {}
};
