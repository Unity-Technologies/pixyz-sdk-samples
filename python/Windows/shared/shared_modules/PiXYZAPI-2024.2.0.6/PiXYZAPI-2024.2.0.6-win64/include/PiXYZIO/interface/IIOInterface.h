...
public:
   ...
   */
   virtual void exportSceneToDTPlatform(const SceneI::Occurrence & root, const CoreI::String & directory) = 0;
   ...
   */
   virtual void exportSceneToReflect(const SceneI::Occurrence & root = 1, const CoreI::String & sourceName = "", const CoreI::String & uid = "", const CoreI::Boolean & keepHierarchy = false, const CoreI::FilePath & configFile = "", const CoreI::Boolean & disableDecimation = true) = 0;
   ...
   /*!
     ...
     \param root Identifier of the destination occurrence
   */
   virtual void importSceneFromDTPlatform(const CoreI::DirectoryPath & directory, const SceneI::Occurrence & root = 0) = 0;
   ...
   */
   virtual void exportScene(const CoreI::OutputFilePath & fileName, const SceneI::Occurrence & root = 0) = 0;
   ...
   */
   virtual void registerImportCallback(const CoreI::String & name, const CoreI::StringList & extensions, importFileCallback callback) = 0;
