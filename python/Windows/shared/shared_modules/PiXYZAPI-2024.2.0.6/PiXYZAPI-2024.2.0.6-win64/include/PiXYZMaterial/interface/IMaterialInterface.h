...
public:
   ...
   */
   virtual void createMaterialsFromMaps(const CoreI::DirectoryPath & directory) = 0;
   ...
   */
   virtual void resizeImage(const Image & image, const CoreI::Int & width, const CoreI::Int & height) = 0;
