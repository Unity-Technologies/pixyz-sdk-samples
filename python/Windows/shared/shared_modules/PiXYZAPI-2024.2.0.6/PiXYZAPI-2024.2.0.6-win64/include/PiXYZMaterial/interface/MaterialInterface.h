...
public:
   ...
   */
   virtual void createMaterialsFromMaps(const CoreI::DirectoryPath & directory) final ;
   ...
   */
   ...
   /*!
     \return formats Image formats that can be imported in Pixyz
   */
   ...
   */
   virtual void resizeImage(const Image & image, const CoreI::Int & width, const CoreI::Int & height) final ;
