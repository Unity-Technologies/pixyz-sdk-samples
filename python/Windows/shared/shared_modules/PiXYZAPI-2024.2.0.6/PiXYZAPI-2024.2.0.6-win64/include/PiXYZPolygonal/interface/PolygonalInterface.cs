...
namespace UnityEngine.Pixyz.Polygonal {
	...
	internal static DressedPoly ConvertValue(ref DressedPoly_c s) {
	...
	internal static DressedPoly_c ConvertValue(DressedPoly s, ref DressedPoly_c ss) {
		Polygonal.PolygonalInterface.Polygonal_DressedPoly_init(ref ss);
		ss.material = (System.UInt32)s.material;
	...
	internal static DressedPolyList ConvertValue(ref DressedPolyList_c s) {
	...
	internal static DressedPolyList_c ConvertValue(DressedPolyList s, ref DressedPolyList_c list) {
		Polygonal.PolygonalInterface.Polygonal_DressedPolyList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		for(int i = 0; i < (int)list.size; ++i) {
	...
	internal static ElementList ConvertValue(ref ElementList_c s) {
	...
	internal static ElementList_c ConvertValue(ElementList s, ref ElementList_c list) {
		Polygonal.PolygonalInterface.Polygonal_ElementList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static VertexList_c ConvertValue(VertexList s, ref VertexList_c list) {
		Polygonal.PolygonalInterface.Polygonal_VertexList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static VertexListList ConvertValue(ref VertexListList_c s) {
		VertexListList list = new VertexListList((int)s.size);
		if (s.size==0) return list;

		int size = Marshal.SizeOf(typeof(VertexList_c));
	...
	internal static VertexListList_c ConvertValue(VertexListList s, ref VertexListList_c list) {
		Polygonal.PolygonalInterface.Polygonal_VertexListList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		for(int i = 0; i < (int)list.size; ++i) {
	...
	internal static EdgeList_c ConvertValue(EdgeList s, ref EdgeList_c list) {
		Polygonal.PolygonalInterface.Polygonal_EdgeList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static EdgeListList_c ConvertValue(EdgeListList s, ref EdgeListList_c list) {
		Polygonal.PolygonalInterface.Polygonal_EdgeListList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		for(int i = 0; i < (int)list.size; ++i) {
	...
	internal static UVCoordList ConvertValue(ref UVCoordList_c s) {
	...
	internal static UVCoordList_c ConvertValue(UVCoordList s, ref UVCoordList_c list) {
		Polygonal.PolygonalInterface.Polygonal_UVCoordList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static PolygonList ConvertValue(ref PolygonList_c s) {
	...
	internal static PolygonList_c ConvertValue(PolygonList s, ref PolygonList_c list) {
		Polygonal.PolygonalInterface.Polygonal_PolygonList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static PolygonListList ConvertValue(ref PolygonListList_c s) {
		PolygonListList list = new PolygonListList((int)s.size);
		if (s.size==0) return list;

		int size = Marshal.SizeOf(typeof(PolygonList_c));
	...
	internal static PolygonListList_c ConvertValue(PolygonListList s, ref PolygonListList_c list) {
		Polygonal.PolygonalInterface.Polygonal_PolygonListList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		for(int i = 0; i < (int)list.size; ++i) {
	...
	internal static PatchList ConvertValue(ref PatchList_c s) {
	...
	internal static PatchList_c ConvertValue(PatchList s, ref PatchList_c list) {
		Polygonal.PolygonalInterface.Polygonal_PatchList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		int[] tab = new int[list.size];
		for (int i = 0; i < (int)list.size; ++i)
			tab[i] = (int)(s.list[i]);
	...
	internal static GetVisiblePolygonsReturn ConvertValue(ref GetVisiblePolygonsReturn_c s) {
		GetVisiblePolygonsReturn ss = new GetVisiblePolygonsReturn();
		ss.polygons = ConvertValue(ref s.polygons);
		ss.pixelCounts = Core.CoreInterface.ConvertValue(ref s.pixelCounts);
		return ss;
	}

	internal static GetVisiblePolygonsReturn_c ConvertValue(GetVisiblePolygonsReturn s, ref GetVisiblePolygonsReturn_c ss) {
		ConvertValue(s.polygons, ref ss.polygons);
		Core.CoreInterface.ConvertValue(s.pixelCounts, ref ss.pixelCounts);
		return ss;
	}
	...
	internal static GetMeshSkinningReturn_c ConvertValue(GetMeshSkinningReturn s, ref GetMeshSkinningReturn_c ss) {
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Geom.Point3_c Polygonal_getNormal(IntPtr _pxz_session_, System.UInt32 Polygon, System.UInt32 Vertex);
		/// <summary>
		/// Return the normal attribute of a polygon at a specified vertex
		/// </summary>
		/// <param name="Polygon">The polygon</param>
		/// <param name="Vertex">The vertex</param>
		public Geom.Point3 GetNormal(System.UInt32 Polygon, System.UInt32 Vertex) {
			var ret = Polygonal_getNormal(api.Session, Polygon, Vertex);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern UVCoordList_c Polygonal_getTextureCoordinates(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		...
		public UVCoordList GetTextureCoordinates(System.UInt32 tessellation) {
			var ret = Polygonal_getTextureCoordinates(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_UVCoordList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern GetVisiblePolygonsReturn_c Polygonal_getVisiblePolygons(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// return the visible polygons from the Visibility attributes (see algo.createVisibilityAttributes)
		/// </summary>
		/// <param name="tessellation">The tessellation of the wanted polygons</param>
		public Polygonal.GetVisiblePolygonsReturn GetVisiblePolygons(System.UInt32 tessellation) {
			var ret = Polygonal_getVisiblePolygons(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			Polygonal.GetVisiblePolygonsReturn retStruct = new Polygonal.GetVisiblePolygonsReturn();
			retStruct.polygons = ConvertValue(ref ret.polygons);
			Polygonal.PolygonalInterface.Polygonal_PolygonList_free(ref ret.polygons);
			retStruct.pixelCounts = ConvertValue(ref ret.pixelCounts);
			Core.CoreInterface.Core_IntList_free(ref ret.pixelCounts);
			return retStruct;
		}
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern PolygonList_c Polygonal_getEdgePolygons(IntPtr _pxz_session_, System.UInt32 edge);
		/// <summary>
		/// Returns the polygons connected to an edge
		/// </summary>
		/// <param name="edge">The edge</param>
		public PolygonList GetEdgePolygons(System.UInt32 edge) {
			var ret = Polygonal_getEdgePolygons(api.Session, edge);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_PolygonList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern VertexList_c Polygonal_getEdgeVertices(IntPtr _pxz_session_, System.UInt32 edge);
		/// <summary>
		/// Returns the vertices of an edge
		/// </summary>
		/// <param name="edge">The edge</param>
		public VertexList GetEdgeVertices(System.UInt32 edge) {
			var ret = Polygonal_getEdgeVertices(api.Session, edge);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_VertexList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern EdgeList_c Polygonal_getEdges(IntPtr _pxz_session_, System.UInt32 tessellation, TopologyCategoryMask_c category);
		/// <summary>
		...
		public EdgeList GetEdges(System.UInt32 tessellation, TopologyCategoryMask category) {
			var category_c = new Polygonal.TopologyCategoryMask_c();
			ConvertValue((Polygonal.TopologyCategoryMask)category, ref category_c);
			var ret = Polygonal_getEdges(api.Session, tessellation, category_c);
			Polygonal.PolygonalInterface.Polygonal_TopologyCategoryMask_free(ref category_c);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_EdgeList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern EdgeList_c Polygonal_getFreeEdges(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// Returns the free edges of a tessellation
		/// </summary>
		/// <param name="tessellation">The tessellation</param>
		public EdgeList GetFreeEdges(System.UInt32 tessellation) {
			var ret = Polygonal_getFreeEdges(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern VertexList_c Polygonal_getFreeVertices(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// Returns the free vertices of a tessellation
		/// </summary>
		/// <param name="tessellation">The tessellation</param>
		public VertexList GetFreeVertices(System.UInt32 tessellation) {
			var ret = Polygonal_getFreeVertices(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern PatchList_c Polygonal_getPatches(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// Returns the patches of a tessellation
		/// </summary>
		/// <param name="tessellation">The tessellation</param>
		public PatchList GetPatches(System.UInt32 tessellation) {
			var ret = Polygonal_getPatches(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_PatchList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern EdgeList_c Polygonal_getPolygonEdges(IntPtr _pxz_session_, System.UInt32 polygon);
		/// <summary>
		/// Returns the edges of a a polygon
		/// </summary>
		/// <param name="polygon">The polygon</param>
		public EdgeList GetPolygonEdges(System.UInt32 polygon) {
			var ret = Polygonal_getPolygonEdges(api.Session, polygon);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern VertexList_c Polygonal_getPolygonVertices(IntPtr _pxz_session_, System.UInt32 polygon);
		/// <summary>
		/// Returns the vertices of a a polygon
		/// </summary>
		/// <param name="polygon">The polygon</param>
		public VertexList GetPolygonVertices(System.UInt32 polygon) {
			var ret = Polygonal_getPolygonVertices(api.Session, polygon);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern PolygonList_c Polygonal_getPolygons(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// Returns the polygons of a tessellation
		/// </summary>
		/// <param name="tessellation">The tessellation</param>
		public PolygonList GetPolygons(System.UInt32 tessellation) {
			var ret = Polygonal_getPolygons(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern EdgeListList_c Polygonal_getTessellationBoundaries(IntPtr _pxz_session_, System.UInt32 tessellation);
		/// <summary>
		/// Get boundary edges of a tessellation grouped by cycles
		/// </summary>
		/// <param name="tessellation">The Tessellation</param>
		public EdgeListList GetTessellationBoundaries(System.UInt32 tessellation) {
			var ret = Polygonal_getTessellationBoundaries(api.Session, tessellation);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
			Polygonal.PolygonalInterface.Polygonal_EdgeListList_free(ref ret);
			return convRet;
		}

		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Geom.Point3_c Polygonal_getVertexCoordinates(IntPtr _pxz_session_, System.UInt32 vertex);
		/// <summary>
		/// Returns the vertex coordinates in the tessellation local space
		/// </summary>
		/// <param name="vertex">The vertex</param>
		public Geom.Point3 GetVertexCoordinates(System.UInt32 vertex) {
			var ret = Polygonal_getVertexCoordinates(api.Session, vertex);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = Geom.GeomInterface.ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern EdgeList_c Polygonal_getVertexEdges(IntPtr _pxz_session_, System.UInt32 vertex);
		/// <summary>
		/// Returns the edges connected to a vertex
		/// </summary>
		/// <param name="vertex">The vertex</param>
		public EdgeList GetVertexEdges(System.UInt32 vertex) {
			var ret = Polygonal_getVertexEdges(api.Session, vertex);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern PolygonList_c Polygonal_getVertexPolygons(IntPtr _pxz_session_, System.UInt32 vertex);
		/// <summary>
		/// Returns the polygons connected to a vertex
		/// </summary>
		/// <param name="vertex">The vertex</param>
		public PolygonList GetVertexPolygons(System.UInt32 vertex) {
			var ret = Polygonal_getVertexPolygons(api.Session, vertex);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
			var convRet = ConvertValue(ref ret);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern VertexList_c Polygonal_getVertices(IntPtr _pxz_session_, System.UInt32 tessellation, TopologyCategoryMask_c category);
		/// <summary>
		/// Returns the vertices of a tessellation
		/// </summary>
		/// <param name="tessellation">The tessellation</param>
		/// <param name="category">Category mask of the wanted edges</param>
		public VertexList GetVertices(System.UInt32 tessellation, TopologyCategoryMask category) {
			var category_c = new Polygonal.TopologyCategoryMask_c();
			ConvertValue((Polygonal.TopologyCategoryMask)category, ref category_c);
			var ret = Polygonal_getVertices(api.Session, tessellation, category_c);
			Polygonal.PolygonalInterface.Polygonal_TopologyCategoryMask_free(ref category_c);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Polygonal_destroyElements(IntPtr _pxz_session_, ElementList_c elements);
		/// <summary>
		/// Destroy all the given elements
		/// </summary>
		/// <param name="elements">List of elements to destroy</param>
		public void DestroyElements(ElementList elements) {
			var elements_c = new Polygonal.ElementList_c();
			ConvertValue((Polygonal.ElementList)elements, ref elements_c);
			Polygonal_destroyElements(api.Session, elements_c);
			Polygonal.PolygonalInterface.Polygonal_ElementList_free(ref elements_c);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
		}
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Polygonal_invertElements(IntPtr _pxz_session_, ElementList_c elements);
		/// <summary>
		/// Invert the orientation of all the given elements
		/// </summary>
		/// <param name="elements">List of elements to invert</param>
		public void InvertElements(ElementList elements) {
			var elements_c = new Polygonal.ElementList_c();
			ConvertValue((Polygonal.ElementList)elements, ref elements_c);
			Polygonal_invertElements(api.Session, elements_c);
			Polygonal.PolygonalInterface.Polygonal_ElementList_free(ref elements_c);
			System.String err = ConvertValue(Polygonal_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
