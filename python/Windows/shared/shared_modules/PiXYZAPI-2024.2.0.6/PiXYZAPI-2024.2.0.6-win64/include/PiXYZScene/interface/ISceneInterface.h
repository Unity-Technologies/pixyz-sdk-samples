...
public:
   ...
   */
   virtual void createHierarchicalClusters(const Occurrence & root, const CoreI::Int & childrenCountByNode = 2, const CoreI::Coeff & minFitting = -1) = 0;
   ...
   */
   virtual GeomI::AABB getAABB(const OccurrenceList & occurrences) = 0;
   ...
   */
   virtual GeomI::MBB getMBB(const OccurrenceList & occurrences) = 0;
   ...
   */
   virtual CoreI::Bool isAncestorOf(const Occurrence & occurrence1, const Occurrence & occurrence2) = 0;
   ...
   */
   ...
   /*!
     ...
     \return occurrence The created Occurrence
   */
   virtual Occurrence createTorus(const CoreI::Double & majorRadius, const CoreI::Double & minorRadius, const CoreI::Int & subdivisionLatitude, const CoreI::Int & subdivisionLongitude) = 0;
   ...
   */
   virtual void configureOoC(const OoCComponent & ooc, const CoreI::String & implementationType, const CoreI::String & implementationParameters) = 0;
   ...
   */
   virtual getOoCConfigurationReturn getOoCConfiguration(const OoCComponent & ooc) = 0;

   /*!
     \return implementationTypes All available Out of Core implementation types
   */
   virtual CoreI::StringList listOoCImplementations() = 0;

   //! Ask an Out of Core component to load its sub-scene
   /*!
     \param ooc An OoC component
   */
   virtual void loadOoC(const OoCComponent & ooc) = 0;

   //! Ask an Out of Core component to unload its sub-scene
   /*!
     \param ooc An OoC component
   */
   virtual void unloadOoC(const OoCComponent & ooc) = 0;
   ...
   */
   virtual OccurrenceList findPartOccurrencesWithUnstitchedFaces(const Occurrence & root) = 0;
   ...
   */
   virtual void mergePartOccurrencesByFinalAssemblies(const OccurrenceList & roots = OccurrenceList(0), const MergeHiddenPartsMode & mergeHiddenPartsMode = MergeHiddenPartsMode::MergeSeparately, const CoreI::Boolean & CollapseToParent = true) = 0;
   ...
   */
   virtual OccurrenceList mergePartOccurrencesWithOpenShells(const Occurrence & root) = 0;
