...
typedef enum {
 ...
 Scene_ComponentType_HLODComponent = 13,
 Scene_ComponentType_CuttingPlaneComponent = 14,
 Scene_ComponentType_ReferencedDataComponent = 15,
 Scene_ComponentType_CameraComponent = 16,
 Scene_ComponentType_FeatureComponent = 17,
 Scene_ComponentType_SubpartMaterial = 18,
} Scene_ComponentType;
...
typedef enum {
 Scene_SceneChangeType_CHILD_INSERTED = 0,
