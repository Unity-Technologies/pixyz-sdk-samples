...
public:
   ...
   */
   ...
   /*!
     ...
     \return viewer 
   */
   virtual ViewI::Viewer getUnityViewSessionViewer(const UnityViewSession & session) final ;
   ...
   */
   ...
   /*!
     \param session View session
   */
   virtual CoreI::Ident addUnityViewSessionInitializedCallback(void(*fp)(void *, const UnityViewSession &), void * userdata = nullptr) final ;
   //! method to remove a callback event
