...
public:
   ...
   */
   virtual void refreshViewer(const Viewer & viewer = -1, const CoreI::Int & frameCount = 1, const CoreI::Boolean & forceUpdate = false) final ;
   ...
   */
   virtual void fitCamera(const GeomI::Vector3 & direction, const CameraType & cameraType, const GeomI::Angle & fov, const Viewer & viewer = -1, const SceneI::Occurrence & fitToOccurrence = 0) final ;
