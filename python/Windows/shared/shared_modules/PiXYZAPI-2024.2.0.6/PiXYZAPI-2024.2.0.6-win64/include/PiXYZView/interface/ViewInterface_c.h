...
// Refresh the viewer
PXZ_EXPORTED void View_refreshViewer(Session * pxzSession, View_Viewer viewer, Core_Int frameCount, Core_Boolean forceUpdate);
...
PXZ_EXPORTED void View_fitCamera(Session * pxzSession, Geom_Vector3 direction, View_CameraType cameraType, Geom_Angle fov, View_Viewer viewer, Scene_Occurrence fitToOccurrence);
typedef struct {
