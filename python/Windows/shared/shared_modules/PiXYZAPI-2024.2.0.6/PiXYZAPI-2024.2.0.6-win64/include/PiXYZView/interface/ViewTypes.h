...
struct AnimationPlayerInfo {
   ...
   CoreI::Double speed;
   AnimationPlayerInfo(CoreI::Bool _isPlaying = false, CoreI::Bool _isLooping = false, SceneI::AnimationTime _currentFrame = 0, CoreI::Double _speed = 0.) : isPlaying(_isPlaying), isLooping(_isLooping), currentFrame(_currentFrame), speed(_speed) {}
};
...
struct QP {
   ...
   CoreI::UInt qpIntra;
   QP(CoreI::UInt _qpInterP = 28, CoreI::UInt _qpInterB = 31, CoreI::UInt _qpIntra = 25) : qpInterP(_qpInterP), qpInterB(_qpInterB), qpIntra(_qpIntra) {}
};
...
struct EncoderSettings {
   ...
   EncoderSettings(CoreI::UInt _frameRate = 30, CoreI::UInt _averageBitRate = 2500000, CoreI::UInt _maxBitRate = 2500000, RateControl _rateControl = RateControl::CONSTQP, QP _qp = QP(), CoreI::UInt _targetQuality = 0) : frameRate(_frameRate), averageBitRate(_averageBitRate), maxBitRate(_maxBitRate), rateControl(_rateControl), qp(_qp), targetQuality(_targetQuality) {}
};
...
struct GraphicsContext {
   GraphicAPI api;
   CoreI::Ptr context;
   GraphicsContext(GraphicAPI _api = GraphicAPI::None, CoreI::Ptr _context = nullptr) : api(_api), context(_context) {}
};
...
struct StreamedViewerInfo {
   ...
   CoreI::Short port;
   Viewer viewer;
   StreamedViewerInfo(CoreI::String _host = "", CoreI::Short _port = 0, Viewer _viewer = -1) : host(_host), port(_port), viewer(_viewer) {}
};
...
struct WebRTCInfo {
   ...
   WebRTCInfo(CoreI::String _signalingUrl = "127.0.0.1:8090", CoreI::String _stunServer = "stun:stun.l.google.com:19302", CoreI::UShort _udpPortRangeBegin = 1024, CoreI::UShort _udpPortRangeEnd = 65535) : signalingUrl(_signalingUrl), stunServer(_stunServer), udpPortRangeBegin(_udpPortRangeBegin), udpPortRangeEnd(_udpPortRangeEnd) {}
};
