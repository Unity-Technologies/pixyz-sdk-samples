...
class History(WindowBase):
    def __init__(self, ui):
        super().__init__()
        self.enable()  # enable History in default ui
        self.ui = ui
        self.undoStack = self.redoStack = []
        self.ui.window.callback_manager.addUndoRedoStackChangedCallback(self.updateStack)

    def __del__(self):
        self.ui.window.callback_manager.removeUndoRedoStackChangedCallback(self.updateStack)
