...
class Shortcuts:
    ...
    def removeShortcutCtrlShift(self, key):
        if not key.lower() in self._shortcutsCtrlShift:
            raise Exception("Shortcut Ctrl+Shift+" + key + " doesn't exist")
        del self._shortcutsCtrlShift[key]
