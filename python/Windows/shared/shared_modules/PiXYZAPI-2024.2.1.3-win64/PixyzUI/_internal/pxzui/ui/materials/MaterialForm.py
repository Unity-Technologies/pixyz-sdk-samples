...
class MaterialForm:
    def __init__(self, ui, materialId=None, preview=False):
        self.ui = ui
        if preview:
            self.materialPreview = MaterialPreview(self.ui.window)
        else:
        ...
        self.materialPatternNamesList = ["unlittexture", "color", "standard", "impostor", "PBR", "line"]
    ...
    def onMaterialChanged(self, materialChangeType, materialId):
        if self.id is not None and self.id == materialId:
