...
class PickResult:
	...
	def __init__(self, occurrences: list[int], positions: list[geom.Point3]) -> None: ...
	...
...
def addUnityViewSessionInitializedCallback(callback: Callable[[int, int, int], None], userdata):
