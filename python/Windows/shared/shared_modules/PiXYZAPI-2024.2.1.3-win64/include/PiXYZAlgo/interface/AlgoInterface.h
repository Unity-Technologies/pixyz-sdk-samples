...
public:
   ...
   */
   virtual CoreI::Double getVisualComparisonFootprint(const SceneI::OccurrenceList & originalOccurrences, const SceneI::OccurrenceList & comparedOccurrences, const CoreI::Int & resolution = 512, const CoreI::Int & viewpointCount = 256, const CoreI::Double & threshold = 0.2, const CoreI::Bool & onHemisphereOnly = false) final ;
   ...
   */
   virtual void identifyLinesOfInterest(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & normal = false, const CoreI::Boolean & uvs = false, const CoreI::IntList & uvChannels = CoreI::IntList(0), const CoreI::Boolean & border = false, const CoreI::Boolean & patches = false, const CoreI::Boolean & nman = false) final ;
   ...
   */
   virtual SceneI::Occurrence meshBooleanOperation(const SceneI::OccurrenceList & occurrencesA, const SceneI::OccurrenceList & occurrencesB, const MeshBooleanOperation & operation) final ;
   ...
   */
   virtual GeomI::Point3ListList meshIntersections(const SceneI::OccurrenceList & occurrencesA, const SceneI::OccurrenceList & occurrencesB) final ;
   ...
   */
   virtual void segmentMesh(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & overwriteLoI = true) final ;
   ...
   */
   virtual void transferUV(const SceneI::Occurrence & source, const SceneI::Occurrence & destination, const CoreI::Int & sourceChannel = 0, const CoreI::Int & destinationChannel = 0, const GeomI::Distance & tolerance = 0.001) final ;
   ...
   */
   virtual void explodeConnectedMeshes(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & explodeNonManifoldEdges = false) final ;
   ...
   */
   virtual SceneI::Occurrence dualContouring(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & filteringSize, const GeomI::Distance & voxelSize, const CoreI::Double & tolerance, const CoreI::Boolean & sameSizeOnAllAxis) final ;
   ...
   */
   virtual void mapUvOnFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel = 0, const CoreI::Boolean & overrideExistingUVs = true, const CoreI::Boolean & useAABB = true, const GeomI::Vector3 & forcedAxis = GeomI::Point3(0, 0, 0)) final ;
   ...
   */
   virtual void mergeUVIslandsRelaxed(const SceneI::OccurrenceList & occurrences, const CoreI::Int & channel, const CoreI::Int & targetIslandCount = 0, const CoreI::Double & energyThreshold = 0.01, const CoreI::Boolean & forceIsolatedFaces = true) final ;
   ...
   */
   virtual void unwrapUV(const SceneI::OccurrenceList & occurrences, const UnwrapUVMethod & method, const CoreI::Int & channel = -1, const CoreI::Boolean & createSeamsFromLoI = false, const CoreI::Int & iterMax = 50, const CoreI::Double & tolerance = 0.00001) final ;
   ...
   */
   virtual GeomI::Affine getFittingCylinder(const SceneI::OccurrenceList & occurrences, const CoreI::Boolean & useAABB = true, const GeomI::Vector3 & forcedAxis = GeomI::Point3(0, 0, 0)) final ;
   ...
   */
   virtual void barySmooth(const SceneI::OccurrenceList & occurrences, const CoreI::Int & iteration = 1) final ;
   ...
   */
   ...
   /*!
     ...
     \param fillWithMaterial If set, the given material will be used to fill the holes
   */
   virtual void remeshSurfacicHoles(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & maxDiameter = 0, const CoreI::Boolean & refine = true, const CoreI::Int & numberOfNeighbors = 3, const MaterialI::Material & fillWithMaterial = 0) final ;
   ...
   */
   virtual void vertexOffset(const SceneI::OccurrenceList & occurrences, const GeomI::Distance & offset = 1) final ;
