...
namespace UnityEngine.Pixyz.CAD {
	...
	[StructLayout(LayoutKind.Sequential)]
	internal struct BrickDefinition_c
	{
		public Int32 type;
		public Int32 length;
		public Int32 width;
	...
	[Serializable]
	[StructLayout(LayoutKind.Sequential)]
	public class BrickDefinitionList {
		public CAD.BrickDefinition[] list;
		public int length { get { return (list != null) ? list.Length : 0; } }
		public BrickDefinitionList(CAD.BrickDefinition[] tab) { list = tab; }
		public static implicit operator CAD.BrickDefinition[](BrickDefinitionList o) { return o.list; }
		public CAD.BrickDefinition this[int index] {
			get { return list[index]; }
			set { list[index] = value; }
		}
		public BrickDefinitionList(int size) { list = new CAD.BrickDefinition[size]; }
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct BrickDefinitionList_c
	{
		public System.UInt64 size;
		public IntPtr ptr;
	}
	...
	public class CurveListList {
		public CAD.CurveList[] list;
		public int length { get { return (list != null) ? list.Length : 0; } }
		public CurveListList(CAD.CurveList[] tab) { list = tab; }
		public static implicit operator CAD.CurveList[](CurveListList o) { return o.list; }
		public CAD.CurveList this[int index] {
			get { return list[index]; }
			set { list[index] = value; }
		}
		public CurveListList(int size) { list = new CAD.CurveList[size]; }
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct CurveListList_c
	{
		public System.UInt64 size;
		public IntPtr ptr;
	}
	...
	public enum ExtrusionBoundaryType
	{
		Full = 0,
		Hole = 1,
		Open = 2,
	...
	public class ProfileLoop
	{
		...
		public ProfileLoop(ProfileLoop o) {
			this.edges = o.edges;
			this.isOuter = o.isOuter;
		}
		public OrientedEdgeList edges;
		public System.Boolean isOuter;
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct ProfileLoop_c
	{
		public OrientedEdgeList_c edges;
		public System.Byte isOuter;
	}

	[Serializable]
	[StructLayout(LayoutKind.Sequential)]
	public class ProfileBase {
		public CAD.ProfileLoop[] list;
		public int length { get { return (list != null) ? list.Length : 0; } }
		public ProfileBase(CAD.ProfileLoop[] tab) { list = tab; }
		public static implicit operator CAD.ProfileLoop[](ProfileBase o) { return o.list; }
		public CAD.ProfileLoop this[int index] {
			get { return list[index]; }
			set { list[index] = value; }
		}
		public ProfileBase(int size) { list = new CAD.ProfileLoop[size]; }
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct ProfileBase_c
	{
		public System.UInt64 size;
		public IntPtr ptr;
	}
	...
	public class ProfileBaseList {
		public CAD.ProfileBase[] list;
		public int length { get { return (list != null) ? list.Length : 0; } }
		public ProfileBaseList(CAD.ProfileBase[] tab) { list = tab; }
		public static implicit operator CAD.ProfileBase[](ProfileBaseList o) { return o.list; }
		public CAD.ProfileBase this[int index] {
			get { return list[index]; }
			set { list[index] = value; }
		}
		public ProfileBaseList(int size) { list = new CAD.ProfileBase[size]; }
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct ProfileBaseList_c
	{
		public System.UInt64 size;
		public IntPtr ptr;
	}
