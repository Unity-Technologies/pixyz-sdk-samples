...
#ifndef _PXZ_CAD_INTERFACE_ICADINTERFACE_H_
#define _PXZ_CAD_INTERFACE_ICADINTERFACE_H_
...
class PXZ_EXPORTED ICADInterface
{
public:
   virtual ~ICADInterface() {}
   ...
   */
   virtual GeomI::Distance getPrecision() = 0;

   //! Set the CAD unity length property
   /*!
     \param precision Unit length
   */
   virtual void setUnitLength(const GeomI::Distance & precision) = 0;
   ...
   */
   virtual BodyList solidIntersection(const Body & A, const Body & B) = 0;
   ...
   /*!
     ...
     \return result List of resulting bodies
   */
   virtual BodyList solidSubtraction(const Body & A, const Body & B) = 0;
   ...
   /*!
     ...
     \return result List of resulting bodies
   */
   virtual BodyList solidUnion(const Body & A, const Body & B) = 0;
   ...
   */
   virtual Curve createBezierCurve(const GeomI::Point3List & poles) = 0;
   ...
   */
   virtual Curve createCircleCurve(const GeomI::Distance & radius, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve createCompositeCurve(const CurveList & CurveList) = 0;
   ...
   */
   virtual Curve createCosinusCurve(const GeomI::Distance & Amplitude, const GeomI::Distance & Offset, const GeomI::Distance & Period, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve createEllipseCurve(const GeomI::Distance & URadius, const GeomI::Distance & VRadius, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve createHelixCurve(const GeomI::Distance & radius, const GeomI::Distance & pitch, const GeomI::Matrix4 & matrix, const CoreI::Boolean & trigonometrixOrientation = true) = 0;
   ...
   */
   virtual Curve createHermiteCurve(const GeomI::Point3 & FirstPoint, const GeomI::Point3 & FirstTangent, const GeomI::Point3 & SecondPoint, const GeomI::Point3 & SecondTangent) = 0;
   ...
   */
   virtual Curve createHyperbolaCurve(const CoreI::Double & URadius, const CoreI::Double & VRadius, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve createIntersectionCurve(const Surface & firstSurface, const Surface & secondSurface, const PolylineCurve & chart, const CoreI::Double & minBounds, const CoreI::Double & maxBounds) = 0;
   ...
   */
   virtual Curve createLineCurve(const GeomI::Point3 & OriginPt, const GeomI::Point3 & DirectionPt) = 0;
   ...
   */
   virtual Curve createNURBSCurve(const CoreI::Int & degree, const CoreI::DoubleList & knots, const GeomI::Point3List & poles, const CoreI::DoubleList & weights = CoreI::DoubleList(0)) = 0;
   ...
   */
   virtual Curve createParabolaCurve(const CoreI::Double & focalLength, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve createPolylineCurve(const GeomI::Point3List & points, const CoreI::DoubleList & parameters = CoreI::DoubleList(0)) = 0;
   ...
   */
   virtual Curve createSegmentCurve(const GeomI::Point3 & firstPoint, const GeomI::Point3 & secondPoint) = 0;
   ...
   */
   virtual Curve createSurfacicCurve(const Surface & surface, const Curve & curve2D) = 0;
   ...
   */
   virtual Curve createTransformedCurve(const Curve & curve, const GeomI::Matrix4 & matrix) = 0;
   ...
   */
   virtual Curve invertCurve(const Curve & curve, const CoreI::Double & precision) = 0;
   ...
   /*!
     \param profileBase Profile loops to revolve
     \param direction The profile curves will be extruded in this direction
     \param planeOrigin The origin of the plane that bound the extrusion
     \param planeNormal The normal of the plane that bound the extrusion
     \param startTangent The starting tangent corresponding of the normal of the plane in which all profile lie
     \param boundaryType If the profile curves define an area or not
     \param profileEnd The end profile of the extrusion
     \return boundedLinearExtrusion The created body
   */
   virtual Body createBoundedLinearExtrusionBody(const ProfileBase & profileBase, const GeomI::Vector3 & direction, const GeomI::Point3 & planeOrigin, const GeomI::Vector3 & planeNormal, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) = 0;

   //! create a curve extrusion body
   /*!
     \param profileBase Profile loops to revolve
     \param curve The profile curves will be extruded along this curve
     \param startTangent The starting tangent corresponding of the normal of the plane in which all profile lie
     \param boundaryType If the profile curves define an area or not
     \param profileEnd The end profile of the extrusion
     \return curveExtrusion The created body
   */
   virtual Body createCurveExtrusionBody(const ProfileBase & profileBase, const Curve & curve, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) = 0;

   //! create a linear extrusion body
   /*!
     \param profileBase Profile loops to revolve
     \param direction The profile curves will be extruded in this direction
     \param depth The extrusion will stop at the defined depth
     \param startTangent The starting tangent corresponding of the normal of the plane in which all profile lie
     \param boundaryType If the profile curves define an area or not
     \param profileEnd The end profile of the extrusion
     \return linearExtrusion The created body
   */
   virtual Body createLinearExtrusionBody(const ProfileBase & profileBase, const GeomI::Vector3 & direction, const CoreI::Double & depth, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) = 0;

   //! create a linear extrusion body
   /*!
     \param profileBaseList Profile loops to be extruded
     \param profileExtrusionList Extrusion profiles
     \param boundaryType If the profile curves define an area or not
     \return boundedLinearExtrusion The created body
   */
   virtual Body createMultiExtrusionBody(const ProfileBaseList & profileBaseList, const CurveListList & profileExtrusionList, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full) = 0;

   //! create a revolved extrusion body
   /*!
     \param profileBase Profile loops to revolve
     \param center The center of revolution
     \param axis The profile curves will be revolved around this axis
   ...
   */
   virtual Body createRevolveExtrusionBody(const ProfileBase & profileBase, const GeomI::Point3 & center, const GeomI::Vector3 & axis, const CoreI::Double & angle, const GeomI::Vector3 & startTangent, const ExtrusionBoundaryType & boundaryType = ExtrusionBoundaryType::Full, const ProfileBase & profileEnd = ProfileBase(0)) = 0;
   ...
   */
   virtual MaterialI::Material getFaceMaterial(const Face & face) = 0;
   ...
   */
   virtual void setFaceMaterial(const Face & face, const MaterialI::Material & material) = 0;
   ...
   /*!
     ...
     \param model Model
   */
   virtual void addBodyToModel(const Body & body, const Model & model) = 0;
   ...
   /*!
     ...
     \param model Model
   */
   virtual void addEdgeToModel(const Edge & edge, const Model & model) = 0;
   ...
   /*!
     ...
     \param model Model
   */
   virtual void addOpenShellToModel(const OpenShell & shell, const Model & model) = 0;
   ...
   /*!
     ...
     \param model Model
   */
   virtual void addVertexToModel(const Vertex & vtx, const Model & model) = 0;
   ...
   */
   virtual buildFacesReturn buildFaces(const Surface & surface, const LoopList & loopList) = 0;
   ...
   */
   virtual Model createModel(const GeomI::Distance & precision = -1) = 0;

   //! Create a new BrepSession on current thread
   virtual void endThreadBrepSession() = 0;
   ...
   */
   virtual FaceList getAllModelFaces(const Model & model) = 0;
   ...
   */
   virtual BodyList getModelBodies(const Model & model) = 0;
   ...
   */
   virtual EdgeListList getModelBoundaries(const Model & model) = 0;
   ...
   */
   virtual EdgeList getModelEdges(const Model & model) = 0;
   ...
   */
   virtual OpenShellList getModelOpenShells(const Model & model) = 0;
   ...
   */
   virtual CoreI::Double getModelPrecision(const Model & model) = 0;
   ...
   */
   virtual VertexList getModelVertices(const Model & model) = 0;
   ...
   */
   virtual CoreI::EntityList getReferencers(const CADEntity & entity) = 0;

   //! Create a new BrepSession on current thread
   /*!
     \param precision CAD precision for this model
   */
   virtual void startThreadBrepSession(const GeomI::Distance & precision) = 0;
   ...
   */
   virtual Body createBRepCone(const CoreI::Double & radius, const CoreI::Double & height, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createBRepCube(const CoreI::Double & size, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createBRepCylinder(const CoreI::Double & radius, const CoreI::Double & length, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createBRepPlane(const CoreI::Double & length, const CoreI::Double & width, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createBRepSphere(const CoreI::Double & radius, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return body The created Body
   */
   virtual Body createBRepTorus(const CoreI::Double & majorRadius, const CoreI::Double & minorRadius, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual CoreI::Double evalCurvatureOnCurve(const Curve & curve, const CoreI::Double & parameter) = 0;
   ...
   */
   virtual GeomI::Curvatures evalCurvatureOnSurface(const Surface & surface, const GeomI::Point2 & parameter) = 0;
   ...
   /*!
     ...
     \return d2u D2u
   */
   virtual evalOnCurveReturn evalOnCurve(const Curve & curve, const CoreI::Double & parameter, const CoreI::Int & derivation = 0) = 0;
   ...
   /*!
     ...
     \return duv Duv
   */
   virtual evalOnSurfaceReturn evalOnSurface(const Surface & surface, const GeomI::Point2 & parameter, const CoreI::Int & derivation = 0) = 0;
   ...
   */
   virtual ClosedShellList getBodyClosedShells(const Body & body) = 0;
   ...
   */
   virtual getCircleCurveDefinitionReturn getCircleCurveDefinition(const CircleCurve & circleCurve) = 0;
   ...
   */
   virtual OrientedFaceList getClosedShellOrientedFaces(const ClosedShell & closedShell) = 0;
   ...
   */
   virtual getCoEdgeDefinitionReturn getCoEdgeDefinition(const CoEdge & coEdge) = 0;
   ...
   */
   virtual getCompositeCurveDefinitionReturn getCompositeCurveDefinition(const CompositeCurve & compositeCurve) = 0;
   ...
   */
   virtual getConeSurfaceDefinitionReturn getConeSurfaceDefinition(const ConeSurface & coneSurface) = 0;
   ...
   */
   virtual getCurveExtrusionSurfaceDefinitionReturn getCurveExtrusionSurfaceDefinition(const CurveExtrusionSurface & curveExtrusionSurface) = 0;
   ...
   */
   virtual CoreI::Double getCurveLength(const Curve & curve) = 0;
   ...
   */
   virtual Bounds1D getCurveLimits(const Curve & curve) = 0;
   ...
   */
   virtual getCylinderSurfaceDefinitionReturn getCylinderSurfaceDefinition(const CylinderSurface & cylinderSurface) = 0;
   ...
   */
   virtual getEdgeDefinitionReturn getEdgeDefinition(const Edge & edge) = 0;
   ...
   /*!
     ...
     \return length The length of the edge
   */
   virtual CoreI::Double getEdgeLength(const Edge & edge) = 0;

   //! Get the material of the edge, if any
   /*!
     \param edge 
     \return material The material applied to the edge, 0 if no material
   */
   virtual MaterialI::Material getEdgeMaterial(const Edge & edge) = 0;
   ...
   */
   virtual getEllipseCurveDefinitionReturn getEllipseCurveDefinition(const EllipseCurve & ellipseCurve) = 0;
   ...
   /*!
     ...
     \return matrix The transformation matrix of coneSurface
   */
   virtual getEllipticConeSurfaceDefinitionReturn getEllipticConeSurfaceDefinition(const EllipticConeSurface & ellipticConeSurface) = 0;
   ...
   */
   virtual getFaceDefinitionReturn getFaceDefinition(const Face & face) = 0;
   ...
   */
   virtual GeomI::Point2ListList getFaceParametricBoundaries(const Face & face) = 0;
   ...
   */
   virtual getHelixCurveDefinitionReturn getHelixCurveDefinition(const HelixCurve & helixCurve) = 0;
   ...
   */
   virtual getHermiteCurveDefinitionReturn getHermiteCurveDefinition(const HermiteCurve & hermiteCurve) = 0;
   ...
   */
   virtual getHyperbolaCurveDefinitionReturn getHyperbolaCurveDefinition(const HyperbolaCurve & hyperbolaCurve) = 0;
   ...
   */
   virtual getIntersectionCurveDefinitionReturn getIntersectionCurveDefinition(const IntersectionCurve & intersectionCurve) = 0;
   ...
   */
   virtual getLineCurveDefinitionReturn getLineCurveDefinition(const LineCurve & lineCurve) = 0;
   ...
   */
   virtual CoEdgeList getLoopCoEdges(const Loop & loop) = 0;
   ...
   */
   virtual getNURBSCurveDefinitionReturn getNURBSCurveDefinition(const NURBSCurve & nurbsCurve) = 0;
   ...
   */
   virtual getNURBSSurfaceDefinitionReturn getNURBSSurfaceDefinition(const NURBSSurface & nurbsSurface) = 0;
   ...
   */
   virtual getOffsetCurveDefinitionReturn getOffsetCurveDefinition(const OffsetCurve & offsetCurve) = 0;
   ...
   */
   virtual getOffsetSurfaceDefinitionReturn getOffsetSurfaceDefinition(const OffsetSurface & offsetSurface) = 0;
   ...
   */
   virtual OrientedFaceList getOpenShellOrientedFaces(const OpenShell & openShell) = 0;
   ...
   /*!
     ...
     \return matrix The transformation matrix of the hyperbola
   */
   virtual getParabolaCurveDefinitionReturn getParabolaCurveDefinition(const ParabolaCurve & parabolaCurve) = 0;
   ...
   */
   virtual CoreI::Double getParametricPrecisionOnSurface(const Surface & surface, const CoreI::Double & precision) = 0;
   ...
   */
   virtual GeomI::Matrix4 getPlaneSurfaceDefinition(const PlaneSurface & planeSurface) = 0;
   ...
   */
   virtual getPolylineCurveDefinitionReturn getPolylineCurveDefinition(const PolylineCurve & polylineCurve) = 0;
   ...
   */
   virtual getRevolutionSurfaceDefinitionReturn getRevolutionSurfaceDefinition(const RevolutionSurface & revolutionSurface) = 0;
   ...
   */
   virtual getRuledSurfaceDefinitionReturn getRuledSurfaceDefinition(const RuledSurface & ruledSurface) = 0;
   ...
   */
   virtual getSegmentCurveDefinitionReturn getSegmentCurveDefinition(const SegmentCurve & segmentCurve) = 0;
   ...
   */
   virtual getSphereSurfaceDefinitionReturn getSphereSurfaceDefinition(const SphereSurface & sphereSurface) = 0;
   ...
   */
   virtual Bounds2D getSurfaceLimits(const Surface & surface) = 0;
   ...
   */
   virtual getSurfacicCurveDefinitionReturn getSurfacicCurveDefinition(const SurfacicCurve & surfacicCurve) = 0;
   ...
   */
   virtual getTabulatedCylinderSurfaceDefinitionReturn getTabulatedCylinderSurfaceDefinition(const TabulatedCylinderSurface & tabulatedCylinderSurface) = 0;
   ...
   */
   virtual getTorusSurfaceDefinitionReturn getTorusSurfaceDefinition(const TorusSurface & torusSurface) = 0;
   ...
   */
   virtual getTransformedCurveDefinitionReturn getTransformedCurveDefinition(const TransformedCurve & transformedCurve) = 0;
   ...
   */
   virtual GeomI::Point3 getVertexPosition(const Vertex & vertex) = 0;
   ...
   */
   virtual CoreI::Double invertOnCurve(const Curve & curve, const GeomI::Point3 & point, const CoreI::Double & precision = -1) = 0;
   ...
   */
   virtual GeomI::Point2 invertOnSurface(const Surface & surface, const GeomI::Point3 & point, const CoreI::Double & precision = -1) = 0;
   ...
   */
   virtual CoreI::Boolean isCurveClosed(const Curve & curve) = 0;
   ...
   */
   virtual CoreI::Boolean isCurveFinite(const Curve & curve) = 0;
   ...
   */
   virtual isCurvePeriodicReturn isCurvePeriodic(const Curve & curve) = 0;
   ...
   */
   virtual isSurfaceClosedReturn isSurfaceClosed(const Surface & surface) = 0;
   ...
   */
   virtual isSurfacePeriodicReturn isSurfacePeriodic(const Surface & surface) = 0;
   ...
   */
   virtual CoreI::Boolean needTorusShapeCheck(const Surface & surface, const GeomI::Point3List & points) = 0;
   ...
   */
   virtual CoreI::Double projectOnCurve(const Curve & curve, const GeomI::Point3 & point, const CoreI::Double & precision = -1) = 0;
   ...
   */
   virtual GeomI::Point2 projectOnSurface(const Surface & surface, const GeomI::Point3 & point, const CoreI::Double & precision = -1) = 0;
   ...
   */
   virtual void setCoEdgeCurve2D(const CoEdge & coEdge, const Curve & curve2D) = 0;
   ...
   */
   virtual void setCoEdgeSurface(const CoEdge & coEdge, const Surface & surface) = 0;
   ...
   */
   virtual void setCurveLimits(const Curve & curve, const Bounds1D & limits) = 0;
   ...
   */
   virtual void setEdgeMaterial(const Edge & edge, const MaterialI::Material & material) = 0;
   ...
   /*!
     ...
     \return body The created body
   */
   virtual Body createBody(const ClosedShell & outerShell, const ClosedShellList & innerShells = ClosedShellList(0)) = 0;
   ...
   */
   virtual ClosedShell createClosedShell(const FaceList & faces, const GeomI::OrientationList & orientations) = 0;
   ...
   /*!
     ...
     \param computeGateway Needed if 3d curve and 2d curve have different parametrization
     \return coEdge The created edge
   */
   virtual CoEdge createCoEdge(const Edge & edge, const GeomI::Orientation & orientation, const Surface & surface = 0, const Curve & curve2D = 0, const CoreI::Boolean & computeGateway = false) = 0;
   ...
   */
   virtual Edge createEdge(const Curve & curve, const Vertex & startVertex, const Vertex & endVertex) = 0;
   ...
   /*!
     ...
     \return edge The created edge
   */
   virtual Edge createEdgeFromCurve(const Curve & curve) = 0;
   ...
   /*!
     ...
     \param startVertex The start vertex
     \param endVertex The end vertex
     \param bounds The parametrization boundary
     \return edge The created edge
   */
   virtual Edge createEdgeWithBounds(const Curve & curve, const Vertex & startVertex, const Vertex & endVertex, const Bounds1D & bounds) = 0;
   ...
   */
   virtual Face createFace(const Surface & surface, const LoopList & loopList = LoopList(0), const CoreI::Boolean & useSurfaceOrientation = false) = 0;
   ...
   /*!
     ...
     \param deleteIsolatedVertices If true, this will merge isolated vertices in the loop
     \return loop The created loop
   */
   virtual Loop createLoop(const CoEdgeList & coEdges, const CoreI::Boolean & check = true, const CoreI::Boolean & deleteIsolatedVertices = true) = 0;

   //! Create a loop from a finite curve
   /*!
     \param curve The curve to create the loop with
     \return loop The created loop
   */
   virtual Loop createLoopFromCurve(const Curve & curve) = 0;
   ...
   */
   virtual OpenShell createOpenShell(const FaceList & faces, const GeomI::OrientationList & orientations) = 0;
   ...
   */
   virtual Vertex createVertex(const GeomI::Point3 & position) = 0;

   //! Invert a coedge
   /*!
     \param coedge The coedge to invert
   */
   virtual void invertCoEdge(const CoEdge & coedge) = 0;

   //! Invert faces
   /*!
     \param faces The faces to invert
     \param invertLoops If true, invert loops orientation
   */
   virtual void invertFaces(const FaceList & faces, const CoreI::Boolean & invertLoops = true) = 0;

   //! Invert a loop
   /*!
     \param loop The loop to invert
   */
   virtual void invertLoop(const Loop & loop) = 0;
   ...
   */
   virtual CoreI::Boolean isSurfaceFinite(const Surface & surface) = 0;
   ...
   */
   virtual void addPrecisionArea(const Surface & surface, const GeomI::AABR & aabr) = 0;
   ...
   */
   virtual Surface createBezierSurface(const CoreI::Int & degreeU, const CoreI::Int & degreeV, const GeomI::Point3List & poles) = 0;

   //! Create a new cone surface
   /*!
     \param radius Radius of the cone at origin
     \param semiAngle Semi-angle of the cone (in rad)
     \param matrix Positionning matrix of the cone
     \return coneSurface The new cone surface
   */
   virtual Surface createConeSurface(const GeomI::Distance & radius, const CoreI::Double & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createCurveExtrusionSurface(const Curve & generatrixCurve, const Curve & directrixCurve, const Surface & refSurface = 0) = 0;
   ...
   */
   virtual Surface createCylinderSurface(const GeomI::Distance & radius, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createEllipticConeSurface(const GeomI::Distance & radius1, const GeomI::Distance & radius2, const CoreI::Double & semiAngle, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createNURBSSurface(const CoreI::Int & degreeU, const CoreI::Int & degreeV, const CoreI::DoubleList & knotsU, const CoreI::DoubleList & knotsV, const GeomI::Point3List & poles, const CoreI::DoubleList & weights = CoreI::DoubleList(0)) = 0;
   ...
   */
   virtual Surface createOffsetSurface(const Surface & baseSurface, const CoreI::Double & distance) = 0;
   ...
   */
   virtual Surface createPlaneSurface(const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \param startParam Start angle of the revolution surface (in rad)
     \param endParam End angle of the revolution surface (in rad)
     \return revolutionSurface Revolution surface generated by rotating the given curve around the axis
   */
   virtual Surface createRevolutionSurface(const Curve & generatrixCurve, const GeomI::Point3 & axisOrigin, const GeomI::Vector3 & axisDirection, const CoreI::Double & startParam = 0, const CoreI::Double & endParam = CoreI::TwoPi()) = 0;
   ...
   */
   virtual Surface createRuledSurface(const Curve & firstCurve, const Curve & secondCurve) = 0;
   ...
   */
   virtual Surface createSphereSurface(const GeomI::Distance & radius, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   */
   virtual Surface createTabulatedCylinderSurface(const Curve & directrixCurve, const GeomI::Point3 & GeneratixLine, const GeomI::Distance & minRange, const GeomI::Distance & maxRange) = 0;
   ...
   */
   virtual Surface createTorusSurface(const GeomI::Distance & radiusMax, const GeomI::Distance & radiusMin, const GeomI::Matrix4 & matrix = GeomI::IdentityMatrix4()) = 0;
   ...
   /*!
     ...
     \return need Result
   */
   virtual CoreI::Boolean needPrecisionArea(const Surface & surface) = 0;
