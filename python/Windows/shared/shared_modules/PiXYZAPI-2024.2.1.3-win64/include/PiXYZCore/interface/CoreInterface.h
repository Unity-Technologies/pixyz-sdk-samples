...
public:
   ...
   */
   virtual EntityList getEntitiesByType(const EntityType & type, const Boolean & includeUnsubscribed) final ;
   ...
   */
   ...
   virtual CoreI::Ident addAfterUndoRedoCallback(void(*fp)(void *), void * userdata = nullptr) final ;
   //! method to remove a callback event
   ...
   */
   ...
   virtual CoreI::Ident addBeforeUndoRedoCallback(void(*fp)(void *), void * userdata = nullptr) final ;
   //! method to remove a callback event
   ...
   */
   ...
   /*!
     ...
     \return reasons 
   */
   virtual getLicenseErrorReturn getLicenseError() final ;
   ...
   */
   ...
   /*!
     ...
     \param dataPtr 
   */
   virtual void parallelAddJob(const ParallelSession & session, ParallelCallback jobCallback, const Ptr & dataPtr) final ;
   ...
   */
   virtual void addCustomProperties(const EntityList & entities, const StringList & names, const StringList & values = StringList(0), const PropertyTypeList & types = PropertyTypeList(0)) final ;
   ...
   */
   virtual void setProperties(const EntityList & entities, const StringList & propertyNames, const StringList & propertyValues) final ;
   ...
   */
   virtual CoreI::Ident addAfterCustomPropertyAddedCallback(void(*fp)(void *, const Entity &, const String &, const Int &), void * userdata = nullptr) final ;
   //! method to remove a callback event
   ...
   */
   virtual void endUndoRedoStep(const Boolean & deleteIfEmpty = true) final ;
   ...
   */
   ...
   /*!
     ...
     \return userData 
   */
   virtual String getRedoStepUserData(const UInt & index) final ;
   ...
   */
   ...
   /*!
     ...
     \return userData 
   */
   virtual String getUndoStepUserData(const UInt & index) final ;
   ...
   */
   ...
   /*!
     ...
     \param userData 
   */
   virtual void startUndoRedoStep(const String & stepName, const String & userData = "") final ;
   ...
   */
   ...
   /*!
     ...
     \param keepHistory Keep session log history in new log file.
   */
   virtual void setLogFile(const OutputFilePath & path, const Boolean & keepHistory = false) final ;
