...
namespace UnityEngine.Pixyz.IO {
	...
	public enum PriorityImportLevel
	{
		unavailable = 0,
		Priority_1 = 1,
		Priority_2 = 2,
	...
	[StructLayout(LayoutKind.Sequential)]
	internal struct FileFormat_c
	{
		public IntPtr extension;
		public Int32 priority;
		public System.Byte read;
		public System.Byte write;
	...
	public class FileFormatList {
		public IO.FileFormat[] list;
		public int length { get { return (list != null) ? list.Length : 0; } }
		public FileFormatList(IO.FileFormat[] tab) { list = tab; }
		public static implicit operator IO.FileFormat[](FileFormatList o) { return o.list; }
		public IO.FileFormat this[int index] {
			get { return list[index]; }
			set { list[index] = value; }
		}
		public FileFormatList(int size) { list = new IO.FileFormat[size]; }
	}

	[StructLayout(LayoutKind.Sequential)]
	internal struct FileFormatList_c
	{
		public System.UInt64 size;
		public IntPtr ptr;
	}
	...
	// C delegate
	internal delegate void exportFileCallback_c(System.UInt32 rootOccurrence, string filename);
