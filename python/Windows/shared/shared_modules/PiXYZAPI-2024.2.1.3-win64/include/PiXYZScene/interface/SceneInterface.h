...
public:
   ...
   */
   virtual Occurrence createHierarchicalClusters(const Occurrence & root, const CoreI::Int & childrenCountByNode = 2, const CoreI::Coeff & minFitting = -1) final ;
   ...
   */
   virtual GeomI::AABB getAABB(const OccurrenceList & occurrences, const CoreI::Boolean & precise = false) final ;
   ...
   */
   virtual MaterialI::MaterialList getActiveMaterials(const OccurrenceList & occurrences) final ;
   ...
   */
   virtual BRepShape getBrepShape(const Part & part) final ;
   ...
   */
   virtual GeomI::Matrix4List getGlobalMatrices(const OccurrenceList & occurrences) final ;
   ...
   */
   virtual GeomI::Matrix4List getLocalMatrices(const OccurrenceList & occurrences) final ;
   ...
   */
   virtual GeomI::MBB getMBB(const OccurrenceList & occurrences, const GeomI::Vector3 & forcedAxis = GeomI::Point3(0, 0, 0)) final ;
   ...
   */
   virtual CoreI::Double getVolume(const Occurrence & occurrence) final ;
   ...
   */
   virtual CoreI::DoubleList getVolumes(const OccurrenceList & iRoots) final ;
   ...
   */
   virtual CoreI::Bool isAncestorOf(const Occurrence & maybeAncestor, const Occurrence & occurrence) final ;
   ...
   */
   virtual OccurrenceList keepAncestors(const OccurrenceList & occurrences) final ;
   ...
   */
   virtual CoreI::Ident addComponentChangedCallback(void(*fp)(void *, const ComponentChangeType &, const Occurrence &, const Component &), void * userdata = nullptr) final ;
   ...
   */
   ...
   /*!
     ...
     \return occurrence The created Occurrence
   */
   virtual Occurrence createTorus(const CoreI::Double & majorRadius, const CoreI::Double & minorRadius, const CoreI::Int & subdivisionLatitude = 16, const CoreI::Int & subdivisionLongitude = 16, const CoreI::Boolean & generateUV = true) final ;
   ...
   */
   virtual void setSubpartMaterials(const Occurrence & occurrence, const MaterialI::MaterialList & materials, const CoreI::UInt & startIndex = 0) final ;
   ...
   */
   virtual getTessellationParametersReturn getTessellationParameters(const Part & part) final ;
   ...
   */
   virtual OccurrenceList findPartOccurrencesWithUnstitchedOpenShells(const Occurrence & root) final ;
   ...
   */
   virtual void mergePartOccurrencesByFinalAssemblies(const OccurrenceList & roots = OccurrenceList(0), const MergeHiddenPartsMode & mergeHiddenPartsMode = MergeHiddenPartsMode::Destroy, const CoreI::Boolean & CollapseToParent = true) final ;
   ...
   */
   virtual OccurrenceList mergePartOccurrencesWithSingleOpenShellByAssemblies(const Occurrence & root) final ;
   ...
   */
   virtual void setLocalMatrices(const OccurrenceList & occurrencesIds, const GeomI::Matrix4List & matrices, const CoreI::UInt & batchSize) final ;
   ...
   */
   virtual Occurrence createOccurrenceFromAnnotation(const Annotation & annotation, const CoreI::Boolean & convertVisibility = false) final ;
   ...
   */
   virtual ProductView createProductView(const ProductViewDefinition & definition) final ;
   ...
   */
   virtual GeomI::AABB getAnnotationListAABB(const AnnotationList & annotationList) final ;
   ...
   */
   virtual OccurrenceList getPrototypes(const OccurrenceList & occurrences) final ;
   ...
   */
   virtual void setPrototypes(const OccurrenceList & occurrences, const OccurrenceList & prototypes) final ;

   //! Update children prototypes of the given occurrence
   /*!
     \param occurrence The occurrence
   */
   virtual void updateChildrenPrototypes(const Occurrence & occurrence) final ;
   ...
   */
   virtual CoreI::ULong getSelectedPolygonCount() final ;
   ...
   */
   virtual void invertSelect(const OccurrenceList & occurrence) final ;
   ...
   */
   ...
   virtual void endModifyAllVariants() final ;
   ...
   */
   ...
   virtual void startModifyAllVariants() final ;
