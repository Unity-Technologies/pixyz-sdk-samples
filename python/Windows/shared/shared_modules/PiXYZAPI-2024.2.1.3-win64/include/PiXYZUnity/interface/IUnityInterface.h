...
public:
   ...
   */
   virtual CoreI::Ident addUnityViewSessionInitializedCallback(void(*fp)(void *, const UnityViewSession &, const ViewI::Viewer &, const ViewI::GPUScene &), void * userdata = nullptr) = 0;
   //! method to remove a callback event
