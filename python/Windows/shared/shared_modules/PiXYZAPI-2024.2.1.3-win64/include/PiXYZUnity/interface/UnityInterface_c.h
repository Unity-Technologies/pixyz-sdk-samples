...
// Emitted when a session created with CreateUnityViewSession is initialized (via getInitfunction unity plugin event)
   ...
   */
PXZ_EXPORTED Core_Ident Unity_addUnityViewSessionInitializedCallback(Session * pxzSession, void(*fp)(void *, Unity_UnityViewSession, View_Viewer, View_GPUScene), void * userdata = nullptr);
   //! method to remove a callback event
