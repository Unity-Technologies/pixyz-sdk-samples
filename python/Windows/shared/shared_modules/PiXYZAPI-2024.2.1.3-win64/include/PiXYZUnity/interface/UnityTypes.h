...
struct PickResult {
   ...
   explicit PickResult(SceneI::OccurrenceList _occurrences = SceneI::OccurrenceList(), GeomI::Point3List _positions = GeomI::Point3List()) : occurrences(_occurrences), positions(_positions) {}
};
