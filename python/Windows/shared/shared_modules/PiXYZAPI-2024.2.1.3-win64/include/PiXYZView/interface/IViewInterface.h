...
public:
   ...
   */
   virtual GeomI::AABB getLastAABB(const GPUScene & scene, const Viewer & viewer) = 0;
   ...
   */
   virtual void lockGPUSceneUpdate(const GPUScene & scene) = 0;
   ...
   */
   virtual void lockGPUScenesUpdate(const GPUSceneList & scenes) = 0;
   ...
   */
   virtual CoreI::Bool tryLockGPUSceneUpdate(const GPUScene & scene) = 0;
   ...
   */
   virtual CoreI::BoolList tryLockGPUScenesUpdate(const GPUSceneList & scenes) = 0;
   ...
   */
   virtual void unlockGPUSceneUpdate(const GPUScene & scene) = 0;
   ...
   */
   virtual void unlockGPUScenesUpdate(const GPUSceneList & scenes) = 0;
   ...
   */
   ...
   /*!
     ...
     \return axis 
   */
   virtual GeomI::Vector3 getCameraFrontAxis(const Viewer & viewer = -1, const CoreI::UInt & matrixIndex = 0) = 0;
   ...
   /*!
     ...
     \return position 
   */
   virtual GeomI::Vector3 getCameraPosition(const Viewer & viewer = -1, const CoreI::UInt & matrixIndex = 0) = 0;
   ...
   /*!
     ...
     \return axis 
   */
   virtual GeomI::Vector3 getCameraRightAxis(const Viewer & viewer = -1, const CoreI::UInt & matrixIndex = 0) = 0;
   ...
   /*!
     ...
     \return axis 
   */
   virtual GeomI::Vector3 getCameraUpAxis(const Viewer & viewer = -1, const CoreI::UInt & matrixIndex = 0) = 0;
   ...
   */
   virtual void refreshViewer(const Viewer & viewer = -1) = 0;
   ...
   */
   virtual void fitCamera(const GeomI::Vector3 & direction, const CameraType & cameraType = CameraType::Orthographic, const GeomI::Angle & fov = 90, const Viewer & viewer = -1, const SceneI::OccurrenceList & fitToOccurrences = SceneI::OccurrenceList(0)) = 0;
