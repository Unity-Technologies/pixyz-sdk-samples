...
public:
   ...
   void startServer(const CoreI::String& host, const CoreI::UShort& port, const CoreI::Boolean & blocking = true);
   void startClient(const CoreI::String& host, const CoreI::UShort& port);
