...
namespace UnityEngine.Pixyz.Algo {
	...
	public class AlgoInterface : API.Interface {
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		internal static extern void Algo_BricksReturn_init(ref BricksReturn_c str);
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		internal static extern void Algo_BricksReturn_free(ref BricksReturn_c str);
	...
	internal static CAD.BrickDefinition ConvertValue(ref CAD.BrickDefinition_c s) {
		CAD.BrickDefinition ss = new CAD.BrickDefinition();
		ss.type = (CAD.BrickType)s.type;
	...
	internal static CAD.BrickDefinition_c ConvertValue(CAD.BrickDefinition s, ref CAD.BrickDefinition_c ss) {
	...
	internal static CAD.BrickDefinitionList ConvertValue(ref CAD.BrickDefinitionList_c s) {
		CAD.BrickDefinitionList list = new CAD.BrickDefinitionList((int)s.size);
		if (s.size==0) return list;

		int size = Marshal.SizeOf(typeof(CAD.BrickDefinition_c));

		for (int i = 0; i < (int)s.size; ++i) {
			IntPtr p = new IntPtr(s.ptr.ToInt64() + i * size);
			CAD.BrickDefinition_c value = (CAD.BrickDefinition_c)Marshal.PtrToStructure(p, typeof(CAD.BrickDefinition_c));
			list.list[i] = CAD.CADInterface.ConvertValue(ref value);
		}
		return list;
	}

	internal static CAD.BrickDefinitionList_c ConvertValue(CAD.BrickDefinitionList s, ref CAD.BrickDefinitionList_c list) {
		CAD.CADInterface.CAD_BrickDefinitionList_init(ref list, s == null ? 0 : (System.UInt64)s.length);
		if(list.size == 0) return list;
		for(int i = 0; i < (int)list.size; ++i) {
			CAD.BrickDefinition_c elt = new CAD.BrickDefinition_c();
			CAD.CADInterface.ConvertValue(s.list[i], ref elt);
			IntPtr p = new IntPtr(list.ptr.ToInt64() + i * Marshal.SizeOf(typeof(CAD.BrickDefinition_c)));
			Marshal.StructureToPtr(elt, p, true);
		}
		return list;
	}

	internal static BricksReturn ConvertValue(ref BricksReturn_c s) {
		BricksReturn ss = new BricksReturn();
		ss.Root = (System.UInt32)s.Root;
		ss.Bricks = CAD.CADInterface.ConvertValue(ref s.Bricks);
		return ss;
	}

	internal static BricksReturn_c ConvertValue(BricksReturn s, ref BricksReturn_c ss) {
		Algo.AlgoInterface.Algo_BricksReturn_init(ref ss);
		ss.Root = (System.UInt32)s.Root;
	...
	internal static GetUVQualityMetricsReturn_c ConvertValue(GetUVQualityMetricsReturn s, ref GetUVQualityMetricsReturn_c ss) {
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_decimateTarget(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, DecimateOptionsSelector_c targetStrategy, Int32 UVImportance, System.Byte protectTopology, System.UInt64 iterativeThreshold, System.Byte processMeshIndependently, Int32 maxQuadricAge);
		...
		/// <param name="maxQuadricAge">If >0, define the maximum memory (number of collapse) of a vertex before a new evaluation of its quadric</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void DecimateTarget(Scene.OccurrenceList occurrences, DecimateOptionsSelector targetStrategy, UVImportanceEnum UVImportance = (Algo.UVImportanceEnum)0, System.Boolean protectTopology = false, System.UInt64 iterativeThreshold = 5000000, System.Boolean processMeshIndependently = false, System.Int32 maxQuadricAge = -1) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				...
				Algo_decimateTarget(api.Session, occurrences_c, targetStrategy_c, (int)UVImportance, Convert.ToByte(protectTopology), iterativeThreshold, Convert.ToByte(processMeshIndependently), maxQuadricAge);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_filletMesh(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Double value, Int32 filletingMode, Int32 subdivisionNb, System.Byte createFlatChamfer, System.UInt32 material, Int32 uvChannel);
		...
		/// <param name="uvChannel">UV Channel for the created fillet polygons. Defaults: Use an existing channel if there is one.</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void FilletMesh(Scene.OccurrenceList occurrences, System.Double value, FilletingMode filletingMode = (Algo.FilletingMode)0, System.Int32 subdivisionNb = 0, System.Boolean createFlatChamfer = false, System.UInt32 material = 0, System.Int32 uvChannel = -1) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_filletMesh(api.Session, occurrences_c, value, (int)filletingMode, subdivisionNb, Convert.ToByte(createFlatChamfer), material, uvChannel);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern System.Double Algo_getVisualComparisonFootprint(IntPtr _pxz_session_, Scene.OccurrenceList_c originalOccurrences, Scene.OccurrenceList_c comparedOccurrences, Int32 resolution, Int32 viewpointCount, System.Double threshold, System.Byte onHemisphereOnly);

		/// <summary>
		/// Compute the visual footprint of the difference between two sets of occurrences
		/// </summary>
		/// <param name="originalOccurrences">Set of occurrences representing the ground truth</param>
		/// <param name="comparedOccurrences">Set of occurrences to compare with the ground truth</param>
		/// <param name="resolution">Resolution of the viewer</param>
		/// <param name="viewpointCount">Number of viewpoints generated around the bounding sphere of all occurrences</param>
		/// <param name="threshold">Tolerance for pixel comparison</param>
		/// <param name="onHemisphereOnly">Create viewpoints only in the Y+ hemisphere of the bounding sphere</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public System.Double GetVisualComparisonFootprint(Scene.OccurrenceList originalOccurrences, Scene.OccurrenceList comparedOccurrences, System.Int32 resolution = 512, System.Int32 viewpointCount = 256, System.Double threshold = 0.2, System.Boolean onHemisphereOnly = false) {
			try {
				var originalOccurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)originalOccurrences, ref originalOccurrences_c);
				var comparedOccurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)comparedOccurrences, ref comparedOccurrences_c);
				var ret = Algo_getVisualComparisonFootprint(api.Session, originalOccurrences_c, comparedOccurrences_c, resolution, viewpointCount, threshold, Convert.ToByte(onHemisphereOnly));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref originalOccurrences_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref comparedOccurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
				return (System.Double)ret;
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_identifyLinesOfInterest(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Byte normal, System.Byte uvs, Core.IntList_c uvChannels, System.Byte border, System.Byte patches, System.Byte nman);
		...
		/// </summary>
		/// <param name="occurrences">Occurrences of components to process</param>
		/// <param name="normal">Add LoI on sharp normals</param>
		/// <param name="uvs">Add LoI on UV seams</param>
		/// <param name="uvChannels">If empty and uvs=true, add LoI using all UV channels, else only channel specified in the list</param>
		/// <param name="border">Add LoI on boundary edges</param>
		/// <param name="patches">Add LoI on submesh borders</param>
		/// <param name="nman">Add LoI on non-manifolds edges</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void IdentifyLinesOfInterest(Scene.OccurrenceList occurrences, System.Boolean normal = false, System.Boolean uvs = false, Core.IntList uvChannels = null, System.Boolean border = false, System.Boolean patches = false, System.Boolean nman = false) {
			uvChannels = uvChannels ?? new Core.IntList(new System.Int32[] {});
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var uvChannels_c = new Core.IntList_c();
				Core.CoreInterface.ConvertValue((Core.IntList)uvChannels, ref uvChannels_c);
				Algo_identifyLinesOfInterest(api.Session, occurrences_c, Convert.ToByte(normal), Convert.ToByte(uvs), uvChannels_c, Convert.ToByte(border), Convert.ToByte(patches), Convert.ToByte(nman));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				Core.CoreInterface.Core_IntList_free(ref uvChannels_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern System.UInt32 Algo_meshBooleanOperation(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrencesA, Scene.OccurrenceList_c occurrencesB, Int32 operation);

		/// <summary>
		/// WARNING: this function is tagged as 'EXPERIMENTAL'<br/>
		/// Computes the boolean operation between the meshes of two occurrence lists
		/// </summary>
		/// <param name="occurrencesA">Occurrences A</param>
		/// <param name="occurrencesB">Occurrences B</param>
		/// <param name="operation">The operation to perform</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public System.UInt32 MeshBooleanOperation(Scene.OccurrenceList occurrencesA, Scene.OccurrenceList occurrencesB, MeshBooleanOperation operation) {
			try {
				var occurrencesA_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrencesA, ref occurrencesA_c);
				var occurrencesB_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrencesB, ref occurrencesB_c);
				var ret = Algo_meshBooleanOperation(api.Session, occurrencesA_c, occurrencesB_c, (int)operation);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrencesA_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrencesB_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
				return (System.UInt32)ret;
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Geom.Point3ListList_c Algo_meshIntersections(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrencesA, Scene.OccurrenceList_c occurrencesB);
		...
		/// <param name="occurrencesB">Occurrences B</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public Geom.Point3ListList MeshIntersections(Scene.OccurrenceList occurrencesA, Scene.OccurrenceList occurrencesB) {
			try {
				var occurrencesA_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrencesA, ref occurrencesA_c);
				var occurrencesB_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrencesB, ref occurrencesB_c);
				var ret = Algo_meshIntersections(api.Session, occurrencesA_c, occurrencesB_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrencesA_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrencesB_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_segmentMesh(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Byte overwriteLoI);
		...
		/// </summary>
		/// <param name="occurrences">Occurrences of components to process</param>
		/// <param name="overwriteLoI">Overwrite the lines-of-interest parameters if true, else add them</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void SegmentMesh(Scene.OccurrenceList occurrences, System.Boolean overwriteLoI = true) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_segmentMesh(api.Session, occurrences_c, Convert.ToByte(overwriteLoI));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		/// </summary>
		/// <param name="occurrences">Root occurrences to process</param>
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_transferUV(IntPtr _pxz_session_, System.UInt32 source, System.UInt32 destination, Int32 sourceChannel, Int32 destinationChannel, System.Double tolerance);
		...
		/// <param name="tolerance">Geometric tolerance for point projection</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void TransferUV(System.UInt32 source, System.UInt32 destination, System.Int32 sourceChannel = 0, System.Int32 destinationChannel = 0, System.Double tolerance = 0.001) {
			try {
				Algo_transferUV(api.Session, source, destination, sourceChannel, destinationChannel, tolerance);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
			}
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_explodeConnectedMeshes(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Byte explodeNonManifoldEdges);

		/// <summary>
		/// Explode connected set of polygons to part occurrences. New parts will be placed as children of input part occurrences.
		/// </summary>
		/// <param name="occurrences">Part occurrences to process</param>
		/// <param name="explodeNonManifoldEdges">Split connected components along non-manifold edges</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void ExplodeConnectedMeshes(Scene.OccurrenceList occurrences, System.Boolean explodeNonManifoldEdges = false) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_explodeConnectedMeshes(api.Session, occurrences_c, Convert.ToByte(explodeNonManifoldEdges));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_createVisibilityInformation(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 level, Int32 resolution, Int32 sphereCount, System.Double fovX, System.Byte considerTransparentOpaque, System.UInt32 root, System.Byte onHemisphereOnly);
		...
		/// </summary>
		/// <param name="occurrences">Occurrences of components to process</param>
		/// <param name="level">Level of geometries to create visibility information on: Parts, Patches or Polygons</param>
		/// <param name="resolution">Resolution of the visibility viewer</param>
		/// <param name="sphereCount">Number of viewpoints generated around the bounding sphere</param>
		...
		/// <param name="onHemisphereOnly">Create viewpoints only in the Y+ hemisphere of the bounding sphere</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void CreateVisibilityInformation(Scene.OccurrenceList occurrences, SelectionLevel level, System.Int32 resolution, System.Int32 sphereCount, System.Double fovX = 90, System.Boolean considerTransparentOpaque = false, System.UInt32 root = 0, System.Boolean onHemisphereOnly = false) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_createVisibilityInformation(api.Session, occurrences_c, (int)level, resolution, sphereCount, fovX, Convert.ToByte(considerTransparentOpaque), root, Convert.ToByte(onHemisphereOnly));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_createVisibilityInformationAdvanced(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 level, System.Double voxelSize, System.Double minimumCavityVolume, Int32 resolution, Int32 mode, System.Byte considerTransparentOpaque, System.UInt32 root);
		...
		/// <param name="root">Specify another root for occluder scene</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void CreateVisibilityInformationAdvanced(Scene.OccurrenceList occurrences, SelectionLevel level, System.Double voxelSize, System.Double minimumCavityVolume, System.Int32 resolution, InnerOuterOption mode = (Algo.InnerOuterOption)0, System.Boolean considerTransparentOpaque = false, System.UInt32 root = 0) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_createVisibilityInformationAdvanced(api.Session, occurrences_c, (int)level, voxelSize, minimumCavityVolume, resolution, (int)mode, Convert.ToByte(considerTransparentOpaque), root);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Scene.OccurrenceList_c Algo_findOccludedPartOccurrences(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 resolution, Int32 sphereCount, System.Double fovX, System.Byte considerTransparentOpaque, System.UInt32 root, System.Byte onHemisphereOnly);
		...
		/// <param name="onHemisphereOnly">Create viewpoints only in the Y+ hemisphere of the bounding sphere</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public Scene.OccurrenceList FindOccludedPartOccurrences(Scene.OccurrenceList occurrences, System.Int32 resolution, System.Int32 sphereCount, System.Double fovX = 90, System.Boolean considerTransparentOpaque = false, System.UInt32 root = 0, System.Boolean onHemisphereOnly = false) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var ret = Algo_findOccludedPartOccurrences(api.Session, occurrences_c, resolution, sphereCount, fovX, Convert.ToByte(considerTransparentOpaque), root, Convert.ToByte(onHemisphereOnly));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Core.BoolList_c Algo_removeOccludedGeometries(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 level, Int32 resolution, Int32 sphereCount, System.Double fovX, System.Byte considerTransparentOpaque, Int32 adjacencyDepth, Scene.OccurrenceList_c occluders, System.Byte onHemisphereOnly);
		...
		/// <param name="occluders">Specify other occurrences for occluder scene</param>
		/// <param name="onHemisphereOnly">Create viewpoints only in the Y+ hemisphere of the bounding sphere</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public Core.BoolList RemoveOccludedGeometries(Scene.OccurrenceList occurrences, SelectionLevel level, System.Int32 resolution, System.Int32 sphereCount, System.Double fovX = 90, System.Boolean considerTransparentOpaque = false, System.Int32 adjacencyDepth = 1, Scene.OccurrenceList occluders = null, System.Boolean onHemisphereOnly = false) {
			occluders = occluders ?? new Scene.OccurrenceList(new System.UInt32[] {});
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var occluders_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occluders, ref occluders_c);
				var ret = Algo_removeOccludedGeometries(api.Session, occurrences_c, (int)level, resolution, sphereCount, fovX, Convert.ToByte(considerTransparentOpaque), adjacencyDepth, occluders_c, Convert.ToByte(onHemisphereOnly));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occluders_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		/// <param name="occluders">Specify other occurrences for occluder scene</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public Core.BoolList RemoveOccludedGeometriesAdvanced(Scene.OccurrenceList occurrences, SelectionLevel level, System.Double voxelSize, System.Double minimumCavityVolume, System.Int32 resolution, InnerOuterOption mode = (Algo.InnerOuterOption)0, System.Boolean considerTransparentOpaque = false, System.Int32 adjacencyDepth = 1, Scene.OccurrenceList occluders = null) {
			occluders = occluders ?? new Scene.OccurrenceList(new System.UInt32[] {});
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var occluders_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occluders, ref occluders_c);
				var ret = Algo_removeOccludedGeometriesAdvanced(api.Session, occurrences_c, (int)level, voxelSize, minimumCavityVolume, resolution, (int)mode, Convert.ToByte(considerTransparentOpaque), adjacencyDepth, occluders_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occluders_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
		...
		public Core.BoolList RemoveOccludedGeometriesFromPoints(Scene.OccurrenceList occurrences, SelectionLevel level, Geom.Point3List positions, System.Int32 resolution, System.Int32 sphereCount, System.Double fovX = 90, System.Boolean considerTransparentOpaque = false, System.Int32 adjacencyDepth = 1, Scene.OccurrenceList occluders = null) {
			...
			try {
				...
				var occluders_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occluders, ref occluders_c);
				var ret = Algo_removeOccludedGeometriesFromPoints(api.Session, occurrences_c, (int)level, positions_c, resolution, sphereCount, fovX, Convert.ToByte(considerTransparentOpaque), adjacencyDepth, occluders_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
		...
		public Core.BoolList RemoveOccludedGeometriesFromViewPoints(Scene.OccurrenceList occurrences, SelectionLevel level, Geom.Point3List positions, Geom.Point3List directions, Geom.Point3List ups, System.Int32 resolution, System.Double fovX = 90, System.Boolean considerTransparentOpaque = false, System.Int32 adjacencyDepth = 1, Scene.OccurrenceList occluders = null) {
			...
			try {
				...
				var occluders_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occluders, ref occluders_c);
				var ret = Algo_removeOccludedGeometriesFromViewPoints(api.Session, occurrences_c, (int)level, positions_c, directions_c, ups_c, resolution, fovX, Convert.ToByte(considerTransparentOpaque), adjacencyDepth, occluders_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				Geom.GeomInterface.Geom_Point3List_free(ref positions_c);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern System.UInt32 Algo_dualContouring(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Double filteringSize, System.Double voxelSize, System.Double tolerance, System.Byte sameSizeOnAllAxis);
		...
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public System.UInt32 DualContouring(Scene.OccurrenceList occurrences, System.Double filteringSize, System.Double voxelSize, System.Double tolerance, System.Boolean sameSizeOnAllAxis) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var ret = Algo_dualContouring(api.Session, occurrences_c, filteringSize, voxelSize, tolerance, Convert.ToByte(sameSizeOnAllAxis));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_automaticUVMapping(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 channel, System.Double maxAngleDistorsion, System.Double maxAreaDistorsion, System.Byte sharpToSeam, System.Byte forbidOverlapping, System.UInt32 resolution, System.UInt32 padding);
		...
		/// <param name="resolution">Resolution wanted for the final map when repacking at the end</param>
		/// <param name="padding">Set the padding (in pixels) between UV islands when repacking at the end</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void AutomaticUVMapping(Scene.OccurrenceList occurrences, System.Int32 channel = 0, System.Double maxAngleDistorsion = 0.5, System.Double maxAreaDistorsion = -1, System.Boolean sharpToSeam = true, System.Boolean forbidOverlapping = true, System.UInt32 resolution = 1024, System.UInt32 padding = 1) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_automaticUVMapping(api.Session, occurrences_c, channel, maxAngleDistorsion, maxAreaDistorsion, Convert.ToByte(sharpToSeam), Convert.ToByte(forbidOverlapping), resolution, padding);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_mapUvOnFittingCylinder(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 channel, System.Byte overrideExistingUVs, System.Byte useAABB, Geom.Point3_c forcedAxis);
		...
		/// <param name="channel">The UV channel which will contains the texture coordinates</param>
		/// <param name="overrideExistingUVs">If True, override existing UVs on channel</param>
		/// <param name="useAABB">If true use for the fitting the global Axis Aligned Bounding Box (AABB), else use a Minimum Bounding Box (MBB)</param>
		/// <param name="forcedAxis">Forced axis of the Cylinder</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void MapUvOnFittingCylinder(Scene.OccurrenceList occurrences, System.Int32 channel = 0, System.Boolean overrideExistingUVs = true, System.Boolean useAABB = true, Geom.Point3? forcedAxis = null) {
			...
			try {
				...
				Algo_mapUvOnFittingCylinder(api.Session, occurrences_c, channel, Convert.ToByte(overrideExistingUVs), Convert.ToByte(useAABB), forcedAxis_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_mergeUVIslandsAffine(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 channel, System.Double scaleWeights, System.Double maxScaleVariationFactor, System.Double curvatureWeights, System.Double usePolygonsWeights, System.Double useVerticesWeights, Int32 allowedTransformations, System.Byte allowUVInversion);
		...
		/// <param name="allowedTransformations">Allowed transformation: TRSOnly or TRS+Skew</param>
		/// <param name="allowUVInversion">Allow merged UVs to be inverted</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void MergeUVIslandsAffine(Scene.OccurrenceList occurrences, System.Int32 channel = 0, System.Double scaleWeights = 0, System.Double maxScaleVariationFactor = 1.2, System.Double curvatureWeights = -1, System.Double usePolygonsWeights = 1, System.Double useVerticesWeights = -1, TransformationType allowedTransformations = (Algo.TransformationType)0, System.Boolean allowUVInversion = false) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_mergeUVIslandsAffine(api.Session, occurrences_c, channel, scaleWeights, maxScaleVariationFactor, curvatureWeights, usePolygonsWeights, useVerticesWeights, (int)allowedTransformations, Convert.ToByte(allowUVInversion));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_mergeUVIslandsRelaxed(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 channel, Int32 targetIslandCount, System.Double energyThreshold, System.Byte forceIsolatedFaces);
		...
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void MergeUVIslandsRelaxed(Scene.OccurrenceList occurrences, System.Int32 channel, System.Int32 targetIslandCount = 0, System.Double energyThreshold = 0.01, System.Boolean forceIsolatedFaces = true) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_mergeUVIslandsRelaxed(api.Session, occurrences_c, channel, targetIslandCount, energyThreshold, Convert.ToByte(forceIsolatedFaces));
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_unwrapUV(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, Int32 method, Int32 channel, System.Byte createSeamsFromLoI, Int32 iterMax, System.Double tolerance);
		...
		/// </summary>
		/// <param name="occurrences">Part occurrences to process</param>
		/// <param name="method">Minimization method to use for unwrapping (isometric or conformal)</param>
		/// <param name="channel">The UV channel which will contains the texture coordinates</param>
		/// <param name="createSeamsFromLoI">Use Lines of Interest to generate UV islands</param>
		/// <param name="iterMax">For iterative solvers: set the maximum number of iterations allowed</param>
		/// <param name="tolerance">For iterative solvers: set the maximum error threshold</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void UnwrapUV(Scene.OccurrenceList occurrences, UnwrapUVMethod method, System.Int32 channel = -1, System.Boolean createSeamsFromLoI = false, System.Int32 iterMax = 50, System.Double tolerance = 0.00001) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_unwrapUV(api.Session, occurrences_c, (int)method, channel, Convert.ToByte(createSeamsFromLoI), iterMax, tolerance);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern Geom.Affine_c Algo_getFittingCylinder(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Byte useAABB, Geom.Point3_c forcedAxis);

		/// <summary>
		/// Returns the fitting cylinder of a set of occurrences (based on MBB)
		/// </summary>
		/// <param name="occurrences">Occurrences to fit</param>
		/// <param name="useAABB">If true use the global Axis Aligned Bounding Box (AABB), else use a Minimum Bounding Box (MBB)</param>
		/// <param name="forcedAxis">Forced axis of the Cylinder when using MBB</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public Geom.Affine GetFittingCylinder(Scene.OccurrenceList occurrences, System.Boolean useAABB = true, Geom.Point3? forcedAxis = null) {
			forcedAxis = forcedAxis ?? new Geom.Point3() {x = 0, y = 0, z = 0};
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				var forcedAxis_c = new Geom.Point3_c();
				Geom.GeomInterface.ConvertValue((Geom.Point3)forcedAxis, ref forcedAxis_c);
				var ret = Algo_getFittingCylinder(api.Session, occurrences_c, Convert.ToByte(useAABB), forcedAxis_c);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				Geom.GeomInterface.Geom_Point3_free(ref forcedAxis_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
		...
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void BarySmooth(Scene.OccurrenceList occurrences, System.Int32 iteration = 1) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern void Algo_remeshSurfacicHoles(IntPtr _pxz_session_, Scene.OccurrenceList_c occurrences, System.Double maxDiameter, System.Byte refine, Int32 numberOfNeighbors, System.UInt32 fillWithMaterial);
		...
		/// <param name="refine">Refine mesh for more details in holes</param>
		/// <param name="numberOfNeighbors">Number of neighboring vertices to use for the MLS projection</param>
		/// <param name="fillWithMaterial">If set, the given material will be used to fill the holes</param>
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void RemeshSurfacicHoles(Scene.OccurrenceList occurrences, System.Double maxDiameter = 0, System.Boolean refine = true, System.Int32 numberOfNeighbors = 3, System.UInt32 fillWithMaterial = 0) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
				Algo_remeshSurfacicHoles(api.Session, occurrences_c, maxDiameter, Convert.ToByte(refine), numberOfNeighbors, fillWithMaterial);
				Scene.SceneInterface.Scene_OccurrenceList_free(ref occurrences_c);
				System.String err = ConvertValue(Algo_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public void VertexOffset(Scene.OccurrenceList occurrences, System.Double offset = 1) {
			try {
				var occurrences_c = new Scene.OccurrenceList_c();
				Scene.SceneInterface.ConvertValue((Scene.OccurrenceList)occurrences, ref occurrences_c);
