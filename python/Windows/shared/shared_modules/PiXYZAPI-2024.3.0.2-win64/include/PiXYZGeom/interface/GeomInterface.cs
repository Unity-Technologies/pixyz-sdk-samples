...
namespace UnityEngine.Pixyz.Geom {
	...
	internal static FromLookAtMatrixReturn_c ConvertValue(FromLookAtMatrixReturn s, ref FromLookAtMatrixReturn_c ss) {
		...
		[DllImport(PiXYZAPI.PiXYZAPI_dll)]
		private static extern System.Double Geom_getMaxScale(IntPtr _pxz_session_, Matrix4_c matrix);
		...
		[System.Runtime.ExceptionServices.HandleProcessCorruptedStateExceptions]
		public System.Double GetMaxScale(Matrix4 matrix) {
			try {
				var matrix_c = new Geom.Matrix4_c();
				ConvertValue((Geom.Matrix4)matrix, ref matrix_c);
				var ret = Geom_getMaxScale(api.Session, matrix_c);
				Geom.GeomInterface.Geom_Matrix4_free(ref matrix_c);
				System.String err = ConvertValue(Geom_getLastError());
				if(!System.String.IsNullOrEmpty(err))
					throw new Exception(err);
		...
		public static readonly Matrix4 IdentityMatrix4 = new Geom.Matrix4(new Geom.Array4[] {new Geom.Array4(new System.Double[] {1, 0, 0, 0}), new Geom.Array4(new System.Double[] {0, 1, 0, 0}), new Geom.Array4(new System.Double[] {0, 0, 1, 0}), new Geom.Array4(new System.Double[] {0, 0, 0, 1})});
		public static readonly Matrix4 YupToZupMatrix4 = new Geom.Matrix4(new Geom.Array4[] {new Geom.Array4(new System.Double[] {1, 0, 0, 0}), new Geom.Array4(new System.Double[] {0, 0, -1, 0}), new Geom.Array4(new System.Double[] {0, 1, 0, 0}), new Geom.Array4(new System.Double[] {0, 0, 0, 1})});
		public static readonly Matrix4 ZupToYupMatrix4 = new Geom.Matrix4(new Geom.Array4[] {new Geom.Array4(new System.Double[] {1, 0, 0, 0}), new Geom.Array4(new System.Double[] {0, 0, 1, 0}), new Geom.Array4(new System.Double[] {0, -1, 0, 0}), new Geom.Array4(new System.Double[] {0, 0, 0, 1})});
	}
}
