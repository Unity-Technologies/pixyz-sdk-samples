...
typedef enum {
 IO_PriorityImportLevel_unavailable = 0,
 IO_PriorityImportLevel_Priority_1 = 1,
 IO_PriorityImportLevel_Priority_2 = 2,
 IO_PriorityImportLevel_Priority_3 = 3,
 IO_PriorityImportLevel_Priority_4 = 4,
 IO_PriorityImportLevel_Priority_5 = 5,
 IO_PriorityImportLevel_Priority_6 = 6,
 IO_PriorityImportLevel_Priority_7 = 7,
 IO_PriorityImportLevel_Priority_8 = 8,
 IO_PriorityImportLevel_Priority_9 = 9,
 IO_PriorityImportLevel_Priority_10 = 10,
} IO_PriorityImportLevel;

typedef struct {
   Core_String extension;
   IO_PriorityImportLevel priority;
   Core_Boolean read;
   Core_Boolean write;
   Core_String product;
} IO_FileFormat;

PXZ_EXPORTED void IO_FileFormat_init(IO_FileFormat * str);
PXZ_EXPORTED void IO_FileFormat_free(IO_FileFormat * str);
typedef struct {
   size_t size;
   IO_FileFormat * list;
} IO_FileFormatList;

PXZ_EXPORTED void IO_FileFormatList_init(IO_FileFormatList * list, size_t size = 0);
PXZ_EXPORTED void IO_FileFormatList_free(IO_FileFormatList * list);
typedef struct {
   size_t size;
   Core_FilePath * list;
} IO_FilesList;
...
typedef void (*IO_exportFileCallback)(Scene_Occurrence rootOccurrence, Core_FilePath filename);
