...
class PXZ_EXPORTED MaterialInterface : public IMaterialInterface
{
public:
   ...
   */
   virtual void addUniformProperty(const CustomMaterialPattern & pattern, const CoreI::String & name, const ShaderUniformType & type) final ;
   ...
   */
   virtual CoreI::BoolList areOpaques(const MaterialList & materials) final ;

   //! Remove and delete all the materials
   virtual void clearAllMaterials() final ;
   ...
   */
   virtual Image convertFloat32To8BitsImage(const Image & image32F, const CoreI::Double & minValue = -1, const CoreI::Double & maxValue = 1) final ;
   ...
   */
   virtual Image convertHeightMapToNormalMap(const Image & hmap, const CoreI::Double & height = 0.5) final ;
   ...
   */
   virtual Material copyMaterial(const Material & toCopy, const CoreI::Boolean & addToMaterialLibrary) final ;
   ...
   */
   virtual CustomMaterialPattern createCustomMaterialPattern(const CoreI::String & name) final ;
   ...
   */
   virtual Image createImageFromData(const CoreI::ByteList & data, const CoreI::String & name = "img") final ;
   ...
   /*!
     ...
     \return image The created image
   */
   virtual Image createImageFromDefinition(const ImageDefinition & imageDefinition) final ;
   ...
   */
   virtual ImageList createImagesFromDefinitions(const ImageDefinitionList & imageDefinitions) final ;
   ...
   */
   virtual Material createMaterial(const CoreI::String & name, const CoreI::String & pattern, const CoreI::Boolean & addToMaterialLibrary = true) final ;
   ...
   /*!
     ...
     \return material The created material
   */
   virtual Material createMaterialFromDefinition(const MaterialDefinition & materialDefinition) final ;
   ...
   */
   virtual MaterialList createMaterialsFromDefinitions(const MaterialDefinitionList & materialDefinitions) final ;
   ...
   */
   virtual MaterialFromMapsReturn createMaterialsFromMaps(const CoreI::DirectoryPath & directory) final ;
   ...
   */
   virtual void exportImage(const Image & image, const CoreI::OutputFilePath & filename) final ;
   ...
   */
   virtual Image fillUnusedPixels(const Image & image, const CoreI::ColorAlpha & unusedColor) final ;
   ...
   */
   virtual Image filterAO(const Image & aoMap, const Image & normalMap, const CoreI::Double & sigmaPos = 10, const CoreI::Double & sigmaValue = 0.1, const CoreI::Double & sigmaNormal = 0.01, const CoreI::Int & levelCount = 4, const CoreI::Boolean & filterLowValues = true, const CoreI::Double & lowValueThreshold = 0.01) final ;
   ...
   */
   virtual CustomMaterialPattern findCustomMaterialPatternByName(const CoreI::String & name) final ;
   ...
   */
   virtual MaterialList findMaterialsByPattern(const CoreI::String & pattern) final ;
   ...
   */
   virtual MaterialList findMaterialsByProperty(const CoreI::String & propertyName, const CoreI::Regex & propertyValue, const CoreI::Bool & caseInsensitive = false) final ;
   ...
   */
   virtual ColorMaterialInfos getColorMaterialInfos(const Material & material) final ;
   ...
   */
   virtual CustomMaterialPattern getCustomMaterialPattern(const Material & material) final ;
   ...
   */
   virtual CoreI::FormatList getExportImageFormats() final ;
   ...
   */
   virtual ImageDefinition getImageDefinition(const Image & image) final ;
   ...
   */
   virtual ImageDefinitionList getImageDefinitions(const ImageList & images) final ;
   ...
   */
   virtual CoreI::ColorAlpha getImagePixelColor(const Image & image, const CoreI::Int & x, const CoreI::Int & y) final ;
   ...
   */
   virtual getImageSizeReturn getImageSize(const Image & image) final ;
   ...
   */
   virtual getImagesSizesReturn getImagesSizes(const ImageList & images) final ;
   ...
   */
   virtual CoreI::FormatList getImportImageFormats() final ;
   ...
   */
   virtual ImpostorMaterialInfos getImpostorMaterialInfos(const Material & material) final ;
   ...
   */
   virtual MaterialDefinition getMaterialDefinition(const Material & material) final ;
   ...
   */
   virtual MaterialDefinitionList getMaterialDefinitions(const MaterialList & materials) final ;
   ...
   */
   virtual CoreI::ColorAlpha getMaterialMainColor(const Material & material) final ;
   ...
   */
   virtual CoreI::String getMaterialPattern(const Material & material) final ;
   ...
   */
   virtual MaterialPatternType getMaterialPatternType(const Material & material) final ;
   ...
   */
   virtual PBRMaterialInfos getPBRMaterialInfos(const Material & material) final ;
   ...
   */
   virtual getPointsAndMaterialFromTextReturn getPointsAndMaterialFromText(const CoreI::String & text, const CoreI::String & fontName, const CoreI::Int & fontSize, const GeomI::Matrix4 & matrix, const CoreI::Color & colorInput, const CoreI::Double & offset = 0.0, const CoreI::Double & height3D = 0.0) final ;
   ...
   */
   virtual StandardMaterialInfos getStandardMaterialInfos(const Material & material) final ;
   ...
   */
   virtual ShaderUniformType getUniformPropertyType(const CustomMaterialPattern & pattern, const CoreI::String & name) final ;
   ...
   */
   virtual UnlitTextureMaterialInfos getUnlitTextureMaterialInfos(const Material & material) final ;
   ...
   */
   virtual Image importImage(const CoreI::FilePath & filename) final ;
   ...
   */
   virtual CoreI::Boolean isOpaque(const Material & material) final ;

   //! Rename materials to have a unique name for each one
   /*!
     \param materials Materials to rename (rename all materials if empty)
   */
   virtual void makeMaterialNamesUnique(const MaterialList & materials = MaterialList(0)) final ;
   ...
   */
   virtual remapIndexMapReturn remapIndexMap(const ImageList & maps, const CoreI::Int & maxIndices) final ;
   ...
   */
   virtual void resizeImage(const Image & image, const CoreI::Int & width, const CoreI::Int & height, const ResizeFilterMethod & filteringMethod = ResizeFilterMethod::DEFAULT) final ;
   ...
   */
   virtual void setCoeffOrTextureProperty(const Material & material, const CoreI::String & name, const CoeffOrTexture & coeffOrTexture) final ;
   ...
   */
   virtual void setColorAlphaProperty(const Material & material, const CoreI::String & name, const CoreI::ColorAlpha & color) final ;
   ...
   */
   virtual void setColorOrTextureProperty(const Material & material, const CoreI::String & name, const ColorOrTexture & colorOrTexture) final ;
   ...
   */
   virtual void setFragmentShader(const CustomMaterialPattern & pattern, const CoreI::String & code) final ;
   ...
   /*!
     ...
     \param color The color to apply
   */
   virtual void setMaterialMainColor(const Material & material, const CoreI::ColorAlpha & color) final ;
   ...
   */
   virtual void setMaterialPattern(const Material & material, const CoreI::String & pattern) final ;
   ...
   */
   virtual void setPBRMaterialInfos(const Material & material, const PBRMaterialInfos & infos) final ;
   ...
   */
   virtual void setVertexShader(const CustomMaterialPattern & pattern, const CoreI::String & code) final ;
   ...
   */
   virtual void updateImageFromDefinition(const Image & image, const ImageDefinition & imageDefinition) final ;
   ...
   */
   virtual void updateImagesFromDefinitions(const ImageList & image, const ImageDefinitionList & imageDefinitions) final ;

   /*!
     \param type Type of image change
     \param image Image changed
   */
   virtual CoreI::Ident addImageChangedCallback(void(*fp)(void *, const ImageChangeType &, const Image &), void * userdata = nullptr) final ;
   ...
   */
   virtual CoreI::Ident addMaterialChangedCallback(void(*fp)(void *, const MaterialChangeType &, const Material &), void * userdata = nullptr) final ;
   ...
   */
   virtual CoreI::Ptr getMaterialUserData(const MaterialUserData & userDataId, const Material & material) final ;
   ...
   */
   virtual CoreI::PtrList getMultipleMaterialUserData(const MaterialUserData & userDataId, const MaterialList & materials) final ;
   ...
   */
   virtual CoreI::Bool hasMaterialUserData(const MaterialUserData & userDataId, const Material & material) final ;
   ...
   */
   virtual CoreI::BoolList hasMultipleMaterialUserData(const MaterialUserData & userDataId, const MaterialList & materials) final ;
   ...
   */
   virtual void setMaterialUserData(const MaterialUserData & userDataId, const Material & material, const CoreI::Ptr & userData) final ;
   ...
   */
   virtual void setMultipleMaterialUserData(const MaterialUserData & userDataId, const MaterialList & materials, const CoreI::PtrList & userDataList) final ;
   ...
   */
   virtual MaterialUserData subscribeToMaterialUserData() final ;
   ...
   /*!
     ...
     \param material Material that will store the user data
   */
   virtual void unsetMaterialUserData(const MaterialUserData & userDataId, const Material & material) final ;
   ...
   /*!
     ...
     \param materials Materials that will store the user data
   */
   virtual void unsetMultipleMaterialUserData(const MaterialUserData & userDataId, const MaterialList & materials) final ;

   /*!
     \param userDataId UserData identifier to unsubscribe
   */
   virtual void unsubscribeFromMaterialUserData(const MaterialUserData & userDataId) final ;

   /**@}*/

private:
   friend class PiXYZ::PiXYZAPI;
   MaterialInterface(void * session);
   void * _session;
public:
