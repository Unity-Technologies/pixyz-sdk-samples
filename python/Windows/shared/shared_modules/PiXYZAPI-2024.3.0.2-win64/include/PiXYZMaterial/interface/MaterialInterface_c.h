...
PXZ_EXPORTED Core_BoolList Material_areOpaques(Session * pxzSession, Material_MaterialList materials);
...
PXZ_EXPORTED Material_Image Material_createImageFromData(Session * pxzSession, Core_ByteList data, Core_String name);
...
PXZ_EXPORTED Material_MaterialFromMapsReturn Material_createMaterialsFromMaps(Session * pxzSession, Core_DirectoryPath directory);
// Export an image
...
PXZ_EXPORTED Core_FormatList Material_getExportImageFormats(Session * pxzSession);
...
PXZ_EXPORTED Core_ColorAlpha Material_getImagePixelColor(Session * pxzSession, Material_Image image, Core_Int x, Core_Int y);
...
typedef struct {
   Core_IntList widths;
   Core_IntList heights;
} Material_getImagesSizesReturn;
PXZ_EXPORTED Material_getImagesSizesReturn Material_getImagesSizes(Session * pxzSession, Material_ImageList images);
...
// Resize an image
PXZ_EXPORTED void Material_resizeImage(Session * pxzSession, Material_Image image, Core_Int width, Core_Int height, Material_ResizeFilterMethod filteringMethod);
// Set a CoeffOrTexture property
PXZ_EXPORTED void Material_setCoeffOrTextureProperty(Session * pxzSession, Material_Material material, Core_String name, Material_CoeffOrTexture coeffOrTexture);
// Set a ColorAlpha property
PXZ_EXPORTED void Material_setColorAlphaProperty(Session * pxzSession, Material_Material material, Core_String name, Core_ColorAlpha color);
// Set a ColorOrTexture property
PXZ_EXPORTED void Material_setColorOrTextureProperty(Session * pxzSession, Material_Material material, Core_String name, Material_ColorOrTexture colorOrTexture);
