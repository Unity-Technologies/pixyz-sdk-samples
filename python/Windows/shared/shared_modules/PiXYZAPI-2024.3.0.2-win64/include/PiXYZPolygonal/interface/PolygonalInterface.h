...
public:
   ...
   */
   ...
   /*!
     ...
     \return material 
   */
   virtual createMeshFromTextReturn createMeshFromText(const CoreI::String & text, const GeomI::Matrix4 & matrix, const CoreI::String & font = "ChicFont", const CoreI::Int & fontSize = 64, const CoreI::ColorAlpha & color = CoreI::ColorAlpha(), const CoreI::Double & heigth3D = 40) final ;
