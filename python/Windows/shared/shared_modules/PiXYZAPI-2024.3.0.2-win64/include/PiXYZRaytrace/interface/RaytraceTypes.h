...
struct Camera {
   ...
   GeomI::Vector3 up;
   CoreI::Double fov;
   explicit Camera(GeomI::Point3 _position = GeomI::Point3(), GeomI::Vector3 _direction = GeomI::Vector3(), GeomI::Vector3 _up = GeomI::Vector3(), CoreI::Double _fov = 60) : position(_position), direction(_direction), up(_up), fov(_fov) {}
};
